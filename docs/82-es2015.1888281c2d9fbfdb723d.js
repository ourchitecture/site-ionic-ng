(window.webpackJsonp = window.webpackJsonp || []).push([
    [82],
    {
        gaXT: function(t, o, e) {
            'use strict';
            e.r(o),
                e.d(o, 'ion_tab_bar', function() {
                    return r;
                }),
                e.d(o, 'ion_tab_button', function() {
                    return s;
                });
            var i = e('imtE'),
                n = e('AfW+'),
                        ...
                        return Object(i.i)(
                            i.a,
                            {
                                ...
                                class: {
                                    ...
                                    'tab-has-label': e,
                                    'tab-has-icon': o,
                                    'tab-has-label-only': e && !o,
                                    'tab-has-icon-only': o && !e,
                                    [`tab-layout-${l}`]: !0,
                                    'ion-activatable': !0,
                                    'ion-selectable': !0,
                                    'ion-focusable': !0,
