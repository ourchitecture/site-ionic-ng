(window.webpackJsonp = window.webpackJsonp || []).push([
    [55],
    {
        vnES: function(e, t, i) {
            'use strict';
            i.r(t),
                i.d(t, 'ion_nav', function() {
                    return v;
                }),
                i.d(t, 'ion_nav_link', function() {
                    return m;
                });
            var s = i('imtE'),
                n = i('AfW+'),
            ...
            const u = (e, t, i) => {
                    ...
                    for (const o of n) if (s[o] !== i[o]) return !1;
                    return !0;
                },
                d = (e, t) => (e ? (e instanceof l ? e : new l(e, t)) : null),
                v = class {
                    constructor(e) {
                        Object(s.k)(this, e),
                            (this.transInstr = []),
                            ...
                            (this.views = []),
                            (this.animated = !0),
                            (this.ionNavWillLoad = Object(s.e)(
                                this,
                                'ionNavWillLoad',
                                7
                            )),
                            (this.ionNavWillChange = Object(s.e)(
                                this,
                                'ionNavWillChange',
                                3
                            )),
                            (this.ionNavDidChange = Object(s.e)(
                                this,
                                'ionNavDidChange',
                                3
                            ));
                    ...
                    swipeGestureChanged() {
                        this.gesture &&
                            this.gesture.enable(!0 === this.swipeGesture);
                    }
                    rootChanged() {
                        void 0 !== this.root &&
                            (this.useRouter ||
                    ...
                    componentWillLoad() {
                        if (
                            ...
                            const e = Object(s.d)(this);
                            this.swipeGesture = n.b.getBoolean(
                                'swipeBackEnabled',
                                'ios' === e
                            );
                        }
                    ...
                    async componentDidLoad() {
                        this.rootChanged(),
                            (this.gesture = (
                                await i.e(2).then(i.bind(null, 'vYiJ'))
                    ...
                    componentDidUnload() {
                        for (const e of this.views)
                            Object(c.c)(e.element, a.e), e._destroy();
                        this.gesture &&
                    ...
                    insertPages(e, t, i, s) {
                        return this.queueTrns(
                            { insertStart: e, insertViews: t, opts: i },
                            s
                        );
                    }
                    pop(e, t) {
                    ...
                    popTo(e, t, i) {
                        const s = { removeStart: -1, removeCount: -1, opts: t };
                        return (
                            'object' == typeof e && e.component
                                ? ((s.removeView = e), (s.removeStart = 1))
                                : 'number' == typeof e &&
                                  (s.removeStart = e + 1),
                            this.queueTrns(s, i)
                        );
                    ...
                    removeIndex(e, t = 1, i, s) {
                        return this.queueTrns(
                            { removeStart: e, removeCount: t, opts: i },
                            s
                        );
                    }
                    setRoot(e, t, i, s) {
                        return this.setPages([{ page: e, params: t }], i, s);
                    }
                    setPages(e, t, i) {
                        return (
                            null == t && (t = {}),
                    ...
                    setRouteId(e, t, i) {
                        ...
                        if ('root' === i) o = this.setRoot(e, t, a);
                        else {
                            const s = this.views.find((i) => u(i, e, t));
                            s
                                ? (o = this.popTo(
                                      s,
                    ...
                    queueTrns(e, t) {
                        ...
                        return (
                            (e.done = t),
                            e.insertViews &&
                                0 === e.insertViews.length &&
                                (e.insertViews = void 0),
                    ...
                    async runTransition(e) {
                        try {
                            ...
                            const t = this.getActiveSync(),
                                i = this.getEnteringView(e, t);
                            if (!t && !i)
                                throw new Error(
                                    'no views in the stack to be removed'
                                );
                            i && 1 === i.state && (await i.init(this.el)),
                                this.postViewInit(i, t, e);
                            const s =
                                (e.enteringRequiresTransition ||
                                    e.leavingRequiresTransition) &&
                                i !== t
                                    ? await this.transition(i, t, e)
                                    : {
                                          hasCompleted: !0,
                    ...
                    prepareTI(e) {
                        ...
                        if (
                            ((e.opts = e.opts || {}),
                            void 0 === e.opts.delegate &&
                                (e.opts.delegate = this.delegate),
                            void 0 !== e.removeView)
                        ) {
                            Object(r.b)(
                                void 0 !== e.removeStart,
                                'removeView needs removeStart'
                            ),
                                Object(r.b)(
                        ...
                        void 0 !== e.removeStart &&
                            (e.removeStart < 0 && (e.removeStart = t - 1),
                            e.removeCount < 0 &&
                                (e.removeCount = t - e.removeStart),
                            (e.leavingRequiresTransition =
                                e.removeCount > 0 &&
                                e.removeStart + e.removeCount === t)),
                            e.insertViews &&
                                ((e.insertStart < 0 || e.insertStart > t) &&
                                    (e.insertStart = t),
                                (e.enteringRequiresTransition =
                                    e.insertStart === t));
                        const i = e.insertViews;
                        if (!i) return;
                        Object(r.b)(i.length > 0, 'length can not be zero');
                        const s = i
                            .map((e) =>
                                e instanceof l
                                    ? e
                    ...
                    getEnteringView(e, t) {
                        const i = e.insertViews;
                        if (void 0 !== i) return i[i.length - 1];
                        const s = e.removeStart;
                        if (void 0 !== s) {
                            const i = this.views,
                                n = s + e.removeCount;
                            for (let e = i.length - 1; e >= 0; e--) {
                                const r = i[e];
                                if ((e < s || e >= n) && r !== t) return r;
                            }
                        }
                    }
                    postViewInit(e, t, i) {
                        Object(r.b)(
                            ...
                            Object(r.b)(i.resolve, 'resolve must be valid'),
                            Object(r.b)(i.reject, 'reject must be valid');
                        const s = i.opts,
                            n = i.insertViews,
                            o = i.removeStart,
                            h = i.removeCount;
                        ...
                        if (void 0 !== o && void 0 !== h) {
                            Object(r.b)(
                                o >= 0,
                                'removeStart can not be negative'
                            ),
                                Object(r.b)(
                                    h >= 0,
                                    'removeCount can not be negative'
                                ),
                                (l = []);
                            for (let i = 0; i < h; i++) {
                                const s = this.views[i + o];
                                s && s !== e && s !== t && l.push(s);
                            }
                        ...
                        if (
                            (Object(r.b)(
                                u >= 0,
                                'final balance can not be negative'
                            ),
                            0 === u)
                        )
                            throw (console.warn(
                        ...
                        if (n) {
                            let e = i.insertStart;
                            for (const t of n) this.insertViewAt(t, e), e++;
                            i.enteringRequiresTransition &&
                                (s.direction = s.direction || 'forward');
                        }
                        if (l && l.length > 0) {
                            for (const e of l)
                                Object(c.c)(e.element, a.c),
                                    Object(c.c)(e.element, a.d),
                                    Object(c.c)(e.element, a.e);
                            for (const e of l) this.destroyView(e);
                        }
                    }
                    async transition(e, t, i) {
                        const r = i.opts,
                            o = r.progressAnimation
                                ? (e) => (this.sbAni = e)
                                : void 0,
                            a = Object(s.d)(this),
                            h = e.element,
                            ...
                            u = Object.assign(
                                {
                                    ...
                                    animationBuilder:
                                        this.animation ||
                                        r.animationBuilder ||
                                        n.b.get('navAnimation'),
                                    progressCallback: o,
                                    animated:
                                        this.animated &&
                                        n.b.getBoolean('animated', !0),
                                    enteringEl: h,
                                    leavingEl: l,
                                },
                                r
                            ),
                            { hasCompleted: d } = await Object(c.e)(u);
                        return this.transitionFinish(d, e, t, r);
                    }
                    transitionFinish(e, t, i, s) {
                        const n = e ? t : i;
                        return (
                            n && this.cleanup(n),
                            {
                    ...
                    insertViewAt(e, t) {
                        ...
                        s > -1
                            ? (Object(r.b)(
                                  e.nav === this,
                                  'view is not part of the nav'
                              ),
                              i.splice(t, 0, i.splice(s, 1)[0]))
                            : (Object(r.b)(!e.nav, 'nav is used'),
                              (e.nav = this),
                              i.splice(t, 0, e));
                    }
                    removeView(e) {
                        ...
                        const t = this.views,
                            i = t.indexOf(e);
                        Object(r.b)(i > -1, 'view must be part of the stack'),
                            i >= 0 && t.splice(i, 1);
                    }
                    destroyView(e) {
                    ...
                    cleanup(e) {
                        ...
                        for (let s = t.length - 1; s >= 0; s--) {
                            const e = t[s],
                                n = e.element;
                            s > i
                                ? (Object(c.c)(n, a.e), this.destroyView(e))
                                : s < i && Object(c.d)(n, !0);
                        }
                    }
                    canStart() {
                    ...
                    onEnd(e, t, i) {
                        if (this.sbAni) {
                            ...
                            e
                                ...
                                this.sbAni.progressEnd(e ? 1 : 0, s, i);
                        }
                    }
                    render() {
                        return Object(s.i)('slot', null);
                    }
                    get el() {
                ...
                m = class {
                                ...
                                ((e, t, i, s) => {
                                    ...
                                    if (n)
                                        if ('forward' === t) {
                                            ...
                                            if (void 0 !== i)
                                                return n.setRoot(i, s, {
                                                    skipIfBusy: !0,
                                                });
                                        } else if ('back' === t)
                                            return n.pop({ skipIfBusy: !0 });
                                    return Promise.resolve(!1);
                                })(
                                    0,
                    ...
                    render() {
                        return Object(s.i)(s.a, { onClick: this.onClick });
                    }
                    get el() {
                        return Object(s.f)(this);
                    }
