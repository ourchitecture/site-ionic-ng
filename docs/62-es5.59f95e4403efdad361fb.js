...
function _asyncToGenerator(t) {
    return function() {
        ...
        return new Promise(function(i, a) {
            var r = t.apply(e, n);
            function o(t) {
                asyncGeneratorStep(r, i, a, o, s, 'next', t);
            }
            function s(t) {
                asyncGeneratorStep(r, i, a, o, s, 'throw', t);
            }
            o(void 0);
        });
    };
        ...
        '5g9+': function(t, e, n) {
            ...
            var i = n('imtE'),
                    ...
                    function t(e) {
                        ...
                        _classCallCheck(this, t),
                            ...
                            (this.clampBounds = function(t) {
                                return Object(a.c)(n.min, t, n.max);
                            }),
                            (this.ensureValueInBounds = function(t) {
                                return n.dualKnobs
                                    ? {
                                          lower: n.clampBounds(t.lower),
                                          upper: n.clampBounds(t.upper),
                                      }
                                    : n.clampBounds(t);
                            }),
                            (this.handleKeyboard = function(t, e) {
                                var i = n.step;
                                (i = i > 0 ? i : 1),
                                    (i /= n.max - n.min),
                                    e || (i *= -1),
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        'rtl' === document.dir && (i = 1 - i),
                                            (this.pressedKnob =
                                                !this.dualKnobs ||
                                                Math.abs(this.ratioA - i) <
                                                    Math.abs(this.ratioB - i)
                                                    ? 'A'
                                                    : 'B'),
                                ...
                                },
                                {
                                    ...
                                    value: function() {
                                        var t = this.getValue(),
                                            ...
                                            n = this.max;
                                        this.dualKnobs
                                            ? ((this.ratioA = d(t.lower, e, n)),
                                              (this.ratioB = d(t.upper, e, n)))
                                            : (this.ratioA = d(t, e, n));
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        if (this.el.shadowRoot) {
                                            var e = this.el.shadowRoot.querySelector(
                                                'A' === t
                                                    ? '.range-knob-a'
                                                    : '.range-knob-b'
                                            );
                    ...
                    return Object(i.i)(
                        'div',
                        {
                            onKeyDown: function(t) {
                                var e = t.key;
                                'ArrowLeft' === e || 'ArrowDown' === e
                                    ? (c(a, !1),
                                      t.preventDefault(),
                                      t.stopPropagation())
                                    : ('ArrowRight' !== e && 'ArrowUp' !== e) ||
                                      (c(a, !0),
                                      t.preventDefault(),
                                      t.stopPropagation());
                            },
                ...
                l = function(t, e, n, i) {
                    var r = (n - e) * t;
                    return (
                        i > 0 && (r = Math.round(r / i) * i + e),
                        Object(a.c)(e, r, n)
                    );
                },
                d = function(t, e, n) {
                    return Object(a.c)(0, (t - e) / (n - e), 1);
                };
        },
    },
]);
