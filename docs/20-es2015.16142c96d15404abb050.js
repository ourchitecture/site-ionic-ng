    ...
    [20],
    {
        K9Nc: function(t, o, e) {
            ...
            const d = class {
                    ...
                    componentDidLoad() {
                        b(() => {
                            const t = Object(n.f)(window, 'hybrid');
                            n.b.getBoolean('_testing') ||
                                e
                                    .e(7)
                                    .then(e.bind(null, 'a7BO'))
                                    .then((t) => t.startTapClick(n.b)),
                                n.b.getBoolean('statusTap', t) &&
                                    e
                                        .e(5)
                                        .then(e.bind(null, 'bGI/'))
                                        .then((t) => t.startStatusTap()),
                                n.b.getBoolean('inputShims', h()) &&
                                    e
                                        .e(4)
                                        .then(e.bind(null, 'aoIK'))
                                        .then((t) => t.startInputShims(n.b)),
                                n.b.getBoolean('hardwareBackButton', t) &&
                                    Promise.resolve()
                                        .then(e.bind(null, 'EV1M'))
                                        .then((t) =>
                                            t.startHardwareBackButton()
                                        ),
                                e
                                    .e(3)
                                    .then(e.bind(null, '3YLQ'))
                                    .then((t) => t.startFocusVisible());
                        });
                    }
                    render() {
                        const t = Object(i.d)(this);
                        return Object(i.i)(i.a, {
                            class: {
                                [t]: !0,
                                'ion-page': !0,
                                'force-statusbar-padding': n.b.getBoolean(
                ...
                h = () =>
                    Object(n.f)(window, 'ios') && Object(n.f)(window, 'mobile'),
                b = (t) => {
                ...
                g = class {
                    constructor(t) {
                        Object(i.k)(this, t), (this.collapse = !1);
                    }
                    render() {
                        const t = Object(i.d)(this);
                        return Object(i.i)(i.a, {
                ...
                p = class {
                    constructor(t) {
                        Object(i.k)(this, t),
                            ...
                            (this.scrollY = !0),
                            (this.scrollEvents = !1),
                            (this.ionScrollStart = Object(i.e)(
                                this,
                                'ionScrollStart',
                                7
                            )),
                            (this.ionScroll = Object(i.e)(
                                this,
                                'ionScroll',
                                7
                            )),
                            (this.ionScrollEnd = Object(i.e)(
                                this,
                                'ionScrollEnd',
                                7
                            ));
                    ...
                    shouldForceOverscroll() {
                        const { forceOverscroll: t, mode: o } = this;
                        return void 0 === t
                            ? 'ios' === o && Object(n.f)('ios')
                            : t;
                    }
                    resize() {
                        this.fullscreen
                            ? Object(i.g)(this.readDimensions.bind(this))
                    ...
                    readDimensions() {
                        const t = u(this.el),
                            ...
                            e = Math.max(
                                t.offsetHeight - o - this.el.offsetHeight,
                                0
                            );
                        ...
                        (this.lastScroll = o),
                            ...
                            !this.queued &&
                                ...
                                Object(i.g)((o) => {
                                    (this.queued = !1),
                                        (this.detail.event = t),
                                        m(this.detail, this.scrollEl, o, e),
                        ...
                        const s = new Promise((t) => (n = t)),
                            ...
                            h = (t) => {
                                const o = Math.min(1, (t - r) / e) - 1,
                                    s = Math.pow(o, 3) + 1;
                                0 !== c &&
                                    (i.scrollTop = Math.floor(s * c + a)),
                                    0 !== d &&
                                        (i.scrollLeft = Math.floor(s * d + l)),
                                    s < 1 ? requestAnimationFrame(h) : n();
                            };
                        return (
                    ...
                    render() {
                        const { scrollX: t, scrollY: o } = this,
                            e = Object(i.d)(this),
                            ...
                            Object(i.i)(
                                i.a,
                                {
                                    class: Object.assign(
                                        Object.assign(
                                            {},
                                            Object(a.a)(this.color)
                                        ),
                                        {
                                            [e]: !0,
                                            'content-sizing': Object(a.c)(
                                                'ion-popover',
                                                this.el
                                            ),
                                            overscroll: r,
                ...
                m = (t, o, e, i) => {
                    ...
                    if (
                        ...
                        (t.currentY = t.scrollTop = a),
                        (t.deltaX = s - t.startX),
                        (t.deltaY = a - t.startY),
                        l > 0 && l < 100)
                    ) {
                        const o = (a - r) / l;
                        (t.velocityX = ((s - n) / l) * 0.7 + 0.3 * t.velocityX),
                            (t.velocityY = 0.7 * o + 0.3 * t.velocityY);
                    }
                },
                f = class {
                    constructor(t) {
                        Object(i.k)(this, t), (this.translucent = !1);
                    }
                    render() {
                        const t = Object(i.d)(this),
                            o = this.translucent;
                ...
                y = class {
                    ...
                    async setupCollapsibleHeader(t, o) {
                        ...
                        if (
                            ((this.collapsibleMainHeader = Array.from(e).find(
                                (t) => 'condense' !== t.collapse
                            )),
                            !this.collapsibleMainHeader)
                        )
                            return;
                    ...
                    render() {
                        const { translucent: t } = this,
                            o = Object(i.d)(this),
                            e = this.collapse || 'none';
                        return Object(i.i)(
                            i.a,
                            {
                                role: 'banner',
                ...
                x = class {
                    constructor(t) {
                        Object(i.k)(this, t),
                            ...
                            (this.mode = Object(i.d)(this)),
                            (this.animated = !0),
                            (this.ionNavWillLoad = Object(i.e)(
                                this,
                                'ionNavWillLoad',
                                7
                            )),
                            (this.ionNavWillChange = Object(i.e)(
                                this,
                                'ionNavWillChange',
                                3
                            )),
                            (this.ionNavDidChange = Object(i.e)(
                                this,
                                'ionNavDidChange',
                                3
                            ));
                    ...
                    async connectedCallback() {
                        (this.gesture = (
                            await e.e(2).then(e.bind(null, 'vYiJ'))
                    ...
                    async setRoot(t, o, e) {
                        ...
                        return (
                            ...
                            await Object(l.b)(this.delegate, i),
                            !0
                        );
                    }
                    async transition(t, o, e = {}) {
                        ...
                        const { el: i, mode: r } = this,
                            s = this.animated && n.b.getBoolean('animated', !0),
                            a =
                                this.animation ||
                                e.animationBuilder ||
                ...
                O = class {
                    constructor(t) {
                        Object(i.k)(this, t), (this.childrenStyles = new Map());
                    }
                    componentWillLoad() {
                        const t = Array.from(
                                this.el.querySelectorAll('ion-buttons')
                            ),
                        ...
                        const e = t.reverse(),
                            i =
                                e.find((t) => 'end' === t.slot) ||
                                e.find((t) => 'primary' === t.slot) ||
                                e.find((t) => 'secondary' === t.slot);
                        ...
                        return (
                            ...
                            Object(i.i)(
                                ...
                                Object(i.i)(
                                    ...
                                    Object(i.i)('slot', { name: 'start' }),
                                    Object(i.i)('slot', { name: 'secondary' }),
                                    Object(i.i)(
                                        'div',
                                        { class: 'toolbar-content' },
                                        Object(i.i)('slot', null)
                                    ),
                                    Object(i.i)('slot', { name: 'primary' }),
                                    Object(i.i)('slot', { name: 'end' })
                                )
                            )
                        );
                    }
