(window.webpackJsonp = window.webpackJsonp || []).push([
    [72],
    {
        Iymp: function(t, e, n) {
            'use strict';
            n.r(e),
                n.d(e, 'ion_segment', function() {
                    return s;
                }),
                n.d(e, 'ion_segment_button', function() {
                    return c;
                });
            var o = n('imtE'),
                i = n('AfW+'),
            ...
            const s = class {
                    ...
                    Object(o.k)(this, t),
                        ...
                        (this.onClick = (t) => {
                            const e = t.target,
                                n = this.checked;
                            (this.value = e.value),
                                n && this.scrollable && this.checkButton(n, e),
                                (this.checked = e);
                        }),
                        (this.ionChange = Object(o.e)(this, 'ionChange', 7)),
                        (this.ionSelect = Object(o.e)(this, 'ionSelect', 7)),
                ...
                async componentDidLoad() {
                    this.setCheckedClasses(),
                        (this.gesture = (
                            await Promise.resolve().then(n.bind(null, 'AzGJ'))
                        ).createGesture({
                            el: this.el,
                            gestureName: 'segment',
                            gesturePriority: 100,
                ...
                addRipple(t) {
                    ...
                    const e = this.getButtons().find(
                        ...
                        n = (e.shadowRoot || e).querySelector(
                            'ion-ripple-effect'
                        );
                    if (!n) return;
                    const { x: o, y: a } = Object(r.j)(t.event);
                    n.addRipple(o, a).then((t) => t());
                }
                setActivated(t) {
                ...
                activate(t) {
                    const e = t.event.target,
                        n = this.getButtons().find(
                            (t) => t.value === this.value
                        );
                    'ION-SEGMENT-BUTTON' === e.tagName &&
                        (n || (this.value = e.value),
                ...
                setNextIndex(t, e = !1) {
                    ...
                    const c = a.getBoundingClientRect(),
                        ...
                        g = c.width,
                        h = t.currentX,
                        b = document.elementFromPoint(h, c.top + c.height / 2);
                    if (o && !e) {
                        if (n ? h > d + g : h < d) {
                            const t = r - 1;
                            t >= 0 && (l = t);
                        } else if ((n ? h < d : h > d + g) && o && !e) {
                            const t = r + 1;
                            t < i.length && (l = t);
                        }
                ...
                render() {
                    ...
                    return Object(o.i)(
                        ...
                        Object(o.i)(
                            ...
                            'md' === l && Object(o.i)('ion-ripple-effect', null)
                        ),
                        Object(o.i)(
                            'div',
                            {
