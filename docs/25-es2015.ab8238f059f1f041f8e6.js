        ...
        uJLv: function(t, o, a) {
            ...
            const e = class {
                constructor(t) {
                    Object(i.k)(this, t),
                        (this.lastClick = -1e4),
                        (this.blocker = c.GESTURE_CONTROLLER.createBlocker({
                            disableScroll: !0,
                        })),
                        (this.visible = !0),
                        (this.tappable = !0),
                        (this.stopPropagation = !0),
                        (this.ionBackdropTap = Object(i.e)(
                            this,
                            'ionBackdropTap',
                            7
                        ));
                ...
                onTouchStart(t) {
                    (this.lastClick = Object(s.i)(t)), this.emitTap(t);
                }
                onMouseDown(t) {
                    this.lastClick < Object(s.i)(t) - 2500 && this.emitTap(t);
                }
                emitTap(t) {
