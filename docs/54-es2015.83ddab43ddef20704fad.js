            ...
            const p = (e, t) => {
                                ...
                                .keyframes([
                                    {
                                        offset: 0,
                                        filter: 'contrast(0.85)',
                                        transform: `translateY(${i}) scale(${s})`,
                                        borderRadius: '10px 10px 0 0',
                                    },
                                    {
                                        offset: 1,
                ...
                u = (e) => {
                    const t = Object(r.a)(),
                        i = Object(r.a)(),
                        o = Object(r.a)(),
                        s = e.querySelector('.modal-wrapper');
                    return (
                        i
                            .addElement(e.querySelector('ion-backdrop'))
                            .fromTo('opacity', 'var(--backdrop-opacity)', 0),
                        o.addElement(s).keyframes([
                            {
                                offset: 0,
                                opacity: 0.99,
                                transform: 'translateY(0px)',
                ...
                y = class {
                    ...
                    async present() {
                        ...
                        const i = Object(o.d)(this);
                        if (this.swipeToClose && 'ios' === i) {
                            const e =
                                    this.leaveAnimation ||
                                    s.b.get('modalLeave', b),
                                t = (this.animation = e(
                                    this.el,
                                    this.presentingElement
                                ));
