(window.webpackJsonp = window.webpackJsonp || []).push([
    [67],
    {
        Ftzj: function(t, e, s) {
            'use strict';
            s.r(e),
                s.d(e, 'ion_reorder', function() {
                    return i;
                }),
                s.d(e, 'ion_reorder_group', function() {
                    return n;
                });
            var r = s('imtE'),
                o = (s('AfW+'), s('opz7'));
            const i = class {
                ...
                n = class {
                    constructor(t) {
                        Object(r.k)(this, t),
                            ...
                            (this.state = 0),
                            (this.disabled = !0),
                            (this.ionItemReorder = Object(r.e)(
                                this,
                                'ionItemReorder',
                                7
                            ));
                    ...
                    async connectedCallback() {
                        ...
                        t && (this.scrollEl = await t.getScrollElement()),
                            (this.gesture = (
                    ...
                    canStart(t) {
                        ...
                        const e = t.event.target.closest('ion-reorder');
                        if (!e) return !1;
                        const s = c(e, this.el);
                        return !!s && ((t.data = s), !0);
                    }
                    onStart(t) {
                        ...
                        for (let o = 0; o < i.length; o++) {
                            const t = i[o];
                            (n += t.offsetHeight), s.push(n), (t.$ionIndex = o);
                        }
                        const c = r.getBoundingClientRect();
                        if (
                            ((this.containerTop = c.top),
                            (this.containerBottom = c.bottom),
                            this.scrollEl)
                        ) {
                            const t = this.scrollEl.getBoundingClientRect();
                            (this.scrollElInitial = this.scrollEl.scrollTop),
                                (this.scrollElTop = t.top + a),
                                (this.scrollElBottom = t.bottom - a);
                        } else
                            (this.scrollElInitial = 0),
                                (this.scrollElTop = 0),
                                (this.scrollElBottom = 0);
                        (this.lastToIndex = l(e)),
                    ...
                    onMove(t) {
                        ...
                        const s = this.autoscroll(t.currentY),
                            ...
                            i = Math.max(
                                r,
                                Math.min(t.currentY, this.containerBottom - s)
                            ),
                            n = s + i - t.startY,
                            c = this.itemIndexForTop(i - r);
                    ...
                    reorderMove(t, e) {
                        ...
                        for (let o = 0; o < r.length; o++) {
                            ...
                            o > t && o <= e
                                ? (i = `translateY(${-s}px)`)
                                : o < t && o >= e && (i = `translateY(${s}px)`),
                                (r[o].style.transform = i);
                        }
                    }
                    autoscroll(t) {
                        ...
                        return (
                            t < this.scrollElTop
                                ? (e = -h)
                                : t > this.scrollElBottom && (e = h),
                            0 !== e && this.scrollEl.scrollBy(0, e),
                ...
                c = (t, e) => {
                    let s;
                    for (; t; ) {
                        if (((s = t.parentElement), s === e)) return t;
                        t = s;
                    }
                },
                a = 60,
                ...
                u = (t, e, s) => {
                    const r = t[e];
                    return t.splice(e, 1), t.splice(s, 0, r), t.slice();
                };
        },
    },
]);
