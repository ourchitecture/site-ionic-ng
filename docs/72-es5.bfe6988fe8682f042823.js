                        ...
                        _classCallCheck(this, t),
                            ...
                            (this.onClick = function(t) {
                                var e = t.target,
                                    o = n.checked;
                                (n.value = e.value),
                                    o && n.scrollable && n.checkButton(o, e),
                                    (n.checked = e);
                            }),
                        ...
                        _createClass(
                            ...
                            [
                                    ...
                                    value: function() {
                                        ...
                                        try {
                                            for (
                                                ...
                                                i.value.disabled = this.disabled;
                                            }
                                        } catch (a) {
                                            (n = !0), (o = a);
                                        } finally {
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        this.setActivated(!1);
                                        var e = this.setNextIndex(t, !0);
                                        t.event.stopImmediatePropagation(),
                                            e && this.addRipple(t);
                                        var n = this.valueAfterGesture;
                                        void 0 !== n &&
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        if (
                                            ...
                                            if (o) {
                                                var a = Object(r.j)(t.event),
                                                    s = a.x,
                                                    l = a.y;
                                                o.addRipple(s, l).then(function(
                                                    t
                                                ) {
                                                    return t();
                                                });
                                ...
                                },
                                {
                                    key: 'setActivated',
                                    value: function(t) {
                                        this.getButtons().forEach(function(e) {
                                            t
                                                ? e.classList.add(
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        var e = this,
                                            n = t.event.target,
                                            o = this.getButtons().find(function(
                                                t
                                            ) {
                                                return t.value === e.value;
                                            });
                                        'ION-SEGMENT-BUTTON' === n.tagName &&
                                            (o || (this.value = n.value),
                                            this.value === n.value &&
                                                this.setActivated(!0));
                                    },
                                },
                    ...
                    function t(e) {
                        ...
                        _classCallCheck(this, t),
                            ...
                            (this.updateState = function() {
                                n.segmentEl &&
                                    (n.checked = n.segmentEl.value === n.value);
                            });
                    }
                    return (
                        _createClass(
                            ...
                            [
                                {
                                    key: 'connectedCallback',
                                    value: function() {
                                        var t = (this.segmentEl = this.el.closest(
                                            'ion-segment'
                                        ));
                                        t &&
                                            (this.updateState(),
