(window.webpackJsonp = window.webpackJsonp || []).push([
    [57],
    {
        VgKV: function(e, t, o) {
            ...
            var i = o('imtE'),
                r = (o('AfW+'), o('aiEM'), o('1ym9')),
                n = (o('kBU6'), o('EV1M'), o('7TZ+')),
                s = o('Dl6n'),
                a = o('m9yc'),
                p = o('9qPz');
            const l = (e, t) => {
                    let o = 'top',
                        i = 'left';
                    const n = e.querySelector('.popover-content'),
                        s = n.getBoundingClientRect(),
                        a = s.width,
                        p = s.height,
                        l = e.ownerDocument.defaultView.innerWidth,
                        d = e.ownerDocument.defaultView.innerHeight,
                        h = t && t.target && t.target.getBoundingClientRect(),
                        m = null != h && 'top' in h ? h.top : d / 2 - p / 2,
                        b = null != h && 'left' in h ? h.left : l / 2,
                        v = (h && h.width) || 0,
                        f = (h && h.height) || 0,
                        u = e.querySelector('.popover-arrow'),
                        g = u.getBoundingClientRect(),
                        y = g.width,
                        w = g.height;
                    null == h && (u.style.display = 'none');
                    const x = { top: m + f, left: b + v / 2 - y / 2 },
                        j = { top: m + f + (w - 1), left: b + v / 2 - a / 2 };
                    let O = !1,
                        k = !1;
                    j.left < c + 25
                        ? ((O = !0), (j.left = c))
                        : a + c + j.left + 25 > l &&
                          ((k = !0), (j.left = l - a - c), (i = 'right')),
                        m + f + p > d && m - p > 0
                            ? ((x.top = m - (w + 1)),
                              (j.top = m - p - (w - 1)),
                              (e.className = e.className + ' popover-bottom'),
                              (o = 'bottom'))
                            : m + f + p > d && (n.style.bottom = c + '%'),
                        (u.style.top = x.top + 'px'),
                        (u.style.left = x.left + 'px'),
                        (n.style.top = j.top + 'px'),
                        (n.style.left = j.left + 'px'),
                        O &&
                            (n.style.left = `calc(${j.left}px + var(--ion-safe-area-left, 0px))`),
                        k &&
                            (n.style.left = `calc(${j.left}px - var(--ion-safe-area-right, 0px))`),
                        (n.style.transformOrigin = o + ' ' + i);
                    const D = Object(r.a)(),
                        E = Object(r.a)(),
                        P = Object(r.a)();
                    return (
                        E.addElement(e.querySelector('ion-backdrop'))
                ...
                h = (e, t) => {
                    ...
                    let n = 'top',
                        s = i ? 'right' : 'left';
                    const a = e.querySelector('.popover-content'),
                        p = a.getBoundingClientRect(),
                        l = p.width,
                        c = p.height,
                        d = o.defaultView.innerWidth,
                        h = o.defaultView.innerHeight,
                        m = t && t.target && t.target.getBoundingClientRect(),
                        b =
                            null != m && 'bottom' in m
                                ? m.bottom
                                : h / 2 - c / 2,
                    ...
                    f.left < 12
                        ? ((f.left = 12), (s = 'left'))
                        : l + 12 + f.left > d &&
                          ((f.left = d - l - 12), (s = 'right')),
                        b + v + c > h && b - c > 0
                            ? ((f.top = b - c - v),
                              (e.className = e.className + ' popover-bottom'),
                              (n = 'bottom'))
                            : b + v + c > h && (a.style.bottom = '12px');
                    const u = Object(r.a)(),
                        g = Object(r.a)(),
                        y = Object(r.a)(),
                        w = Object(r.a)(),
                ...
                b = class {
                    constructor(e) {
                        Object(i.k)(this, e),
                            ...
                            Object(n.e)(this.el),
                            (this.didPresent = Object(i.e)(
                                this,
                                'ionPopoverDidPresent',
                                7
                            )),
                            (this.willPresent = Object(i.e)(
                                this,
                                'ionPopoverWillPresent',
                                7
                            )),
                            (this.willDismiss = Object(i.e)(
                                this,
                                'ionPopoverWillDismiss',
                                7
                            )),
                            (this.didDismiss = Object(i.e)(
                                this,
                    ...
                    async present() {
                        ...
                        const e = this.el.querySelector('.popover-content');
                        if (!e) throw new Error('container is undefined');
                        const t = Object.assign(
                            Object.assign({}, this.componentProps),
                            { popover: this.el }
                        );
                        return (
                            (this.usersElement = await Object(a.a)(
                                this.delegate,
                                e,
                                this.component,
                            ...
                            await Object(p.a)(this.usersElement),
                            Object(n.f)(this, 'popoverEnter', l, h, this.event)
                        );
                    }
                    async dismiss(e, t) {
                        const o = await Object(n.g)(
                            this,
                            e,
                            t,
                            'popoverLeave',
                    ...
                    onDidDismiss() {
                        return Object(n.h)(this.el, 'ionPopoverDidDismiss');
                    }
                    onWillDismiss() {
                        return Object(n.h)(this.el, 'ionPopoverWillDismiss');
                    }
                    render() {
                        const e = Object(i.d)(this),
                            { onLifecycle: t } = this;
                        return Object(i.i)(
                            i.a,
                            {
                            ...
                            Object(i.i)(
                                ...
                                Object(i.i)('div', { class: 'popover-arrow' }),
                                Object(i.i)('div', { class: 'popover-content' })
                            )
                        );
                    }
                    get el() {
