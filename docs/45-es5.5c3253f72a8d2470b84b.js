function asyncGeneratorStep(t, i, e, n, o, s, r) {
    try {
        var a = t[s](r),
            l = a.value;
    } catch (d) {
    ...
    a.done ? i(l) : Promise.resolve(l).then(n, o);
}
function _asyncToGenerator(t) {
    return function() {
        ...
        return new Promise(function(n, o) {
            var s = t.apply(i, e);
            function r(t) {
                asyncGeneratorStep(s, n, o, r, a, 'next', t);
            }
            function a(t) {
                asyncGeneratorStep(s, n, o, r, a, 'throw', t);
            }
            r(void 0);
        });
    };
}
function _defineProperty(t, i, e) {
    return (
        i in t
                ...
                l = (function() {
                    function t(i) {
                        _classCallCheck(this, t),
                            Object(o.k)(this, i),
                            (this.side = 'end'),
                            (this.ionSwipe = Object(o.e)(this, 'ionSwipe', 7));
                    }
                    var i;
                    return (
                        _createClass(
                ...
                d = (function() {
                    function t(i) {
                        _classCallCheck(this, t),
                            ...
                            (this.state = 2),
                            (this.disabled = !1),
                            (this.ionDrag = Object(o.e)(this, 'ionDrag', 7));
                    }
                    var i, r, a, l, d;
                    return (
                        _createClass(
                                                        ...
                                                        function(t) {
                                                            for (;;)
                                                                switch (
                                                                    ...
                                                                    case 0:
                                                                        return (
                                                                            (this.item = this.el.querySelector(
                                                                                'ion-item'
                                                                            )),
                                                                            (t.next = 3),
                                                                            this.updateOptions()
                                                                    ...
                                                                    (e = this.getOptions(
                                                                        ...
                                                                        (this
                                                                            ...
                                                                            requestAnimationFrame(
                                                                                function() {
                                                                                    o.calculateOptsWidth(),
                                                                                        (n =
                                                                                            o.el),
                                                                                        o.setOpenAmount(
                                                                                            'end' ===
                                                                                                i
                                                                                                ? o.optsWidthRightSide
                                                                                                : -o.optsWidthLeftSide,
                                                                                            !1
                                                                                        ),
                                                                                        (o.state =
                                    ...
                                    value: function(t, i) {
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                this.state =
                                                    t <=
                                                    -this.optsWidthLeftSide - 30
                                                        ? 80
                                                        : 16;
                                            }
                                            (o.transform = 'translate3d('.concat(
                                                -t,
                                                'px,0,0)'
                                            )),
                                                this.ionDrag.emit({
