    ...
    [48],
    {
        '8bam': function(t, i, e) {
            ...
            const a = class {
                ...
                l = class {
                    constructor(t) {
                        Object(n.k)(this, t), (this.sticky = !1);
                    }
                    render() {
                ...
                g = class {
                    constructor(t) {
                        Object(n.k)(this, t), (this.inset = !1);
                    }
                    async closeSlidingItems() {
                        const t = this.el.querySelector('ion-item-sliding');
                        return !(!t || !t.closeOpened) && t.closeOpened();
                    }
                    render() {
                        const t = Object(n.d)(this),
                            { lines: i, inset: e } = this;
                        return Object(n.i)(n.a, {
                            class: {
                                [t]: !0,
                                [`list-${t}`]: !0,
                                'list-inset': e,
                                [`list-lines-${i}`]: void 0 !== i,
                                [`list-${t}-lines-${i}`]: void 0 !== i,
                            },
                        });
                    }
                    get el() {
                ...
                h = class {
                    constructor(t) {
                        Object(n.k)(this, t), (this.animated = !1);
                    }
                    render() {
                        const t =
