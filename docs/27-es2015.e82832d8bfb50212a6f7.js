    ...
    [27],
    {
        s1jK: function(o, t, n) {
            ...
            const a = class {
                constructor(o) {
                    Object(i.k)(this, o),
                        ...
                        (this.handleClick = (o) => {
                            if ('button' === this.type)
                                Object(r.d)(this.href, o, this.routerDirection);
                            else if (Object(e.g)(this.el)) {
                ...
                render() {
                    const o = Object(i.d)(this),
                        ...
                        p = void 0 === l && this.inItem ? 'small' : l,
                        v = void 0 === c ? 'button' : 'a',
                        f =
                            'button' === v
                                ? { type: n }
                    ...
                    return (
                        void 0 === m &&
                            (m =
                                this.inToolbar || this.inListHeader
                                    ? 'clear'
                                    : 'solid'),
                        Object(i.i)(
                            i.a,
                            {
                                ...
                                class: Object.assign(
                                    Object.assign({}, Object(r.a)(d)),
                                    {
                                        ...
                                        [`${t}-${m}`]: !0,
                                        [`${t}-strong`]: g,
                                        'in-toolbar': Object(r.c)(
                                            'ion-toolbar',
                                            this.el
                                        ),
                                        'in-toolbar-color': Object(r.c)(
                                            'ion-toolbar[color]',
                                            this.el
                                        ),
                            ...
                            Object(i.i)(
                                ...
                                Object(i.i)(
                                    ...
                                    Object(i.i)('slot', { name: 'icon-only' }),
            ...
            const l = (o, t, n, i, e) => (
                ...
                c = (o) => (b(o) && ((o = o.trim()), d(o)) ? o : null),
                d = (o) => o.length > 0 && /(\/|\.)/.test(o),
                b = (o) => 'string' == typeof o,
                h = (o) => o.toLowerCase(),
                u = (o) => {
                    if (1 === o.nodeType) {
                        ...
                        for (let t = 0; t < o.attributes.length; t++) {
                            ...
                            if (b(n) && 0 === n.toLowerCase().indexOf('on'))
                                return !1;
                        }
                        for (let t = 0; t < o.childNodes.length; t++)
                            if (!u(o.childNodes[t])) return !1;
                    }
                    return !0;
                },
                g = new Map(),
                                ...
                                if (
                                    ...
                                    return (
                                        ...
                                        (() => {
                                            ...
                                            Object(i.j)(`svg/${n}.svg`)
                                    );
                                var n;
                                if (o.icon) {
                                    if (((t = c(o.icon)), t)) return t;
                                    if (((t = c(o.icon[o.mode])), t)) return t;
                                }
                                return null;
                            })(this);
                            o &&
                                (g.has(o)
                                    ? (this.svgContent = g.get(o))
                                    : ((o) => {
                                          let t = p.get(o);
                                          if (!t) {
                            ...
                            t =
                                ...
                                (this.ariaLabel &&
                                    (this.ariaLabel.indexOf('arrow') > -1 ||
                                        this.ariaLabel.indexOf('chevron') >
                                            -1) &&
                                    !1 !== this.flipRtl);
                        return Object(i.i)(
                            i.a,
                            {
                                role: 'img',
                                class: Object.assign(
                                    Object.assign({ [o]: !0 }, m(this.color)),
                                    {
                                        [`icon-${this.size}`]: !!this.size,
                                        'flip-rtl':
                                            !!t &&
                                            'rtl' === this.el.ownerDocument.dir,
                                    }
                                ),
                            },
                            this.svgContent
                                ...
                                : Object(i.i)('div', { class: 'icon-inner' })
                        );
                    }
                ...
                f = () =>
                    ...
                    'md',
                m = (o) =>
                    o ? { 'ion-color': !0, [`ion-color-${o}`]: !0 } : null;
        },
    },
]);
