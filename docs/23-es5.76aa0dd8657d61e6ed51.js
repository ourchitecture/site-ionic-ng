...
function asyncGeneratorStep(t, n, e, o, i, r, a) {
    try {
        var c = t[r](a),
            s = c.value;
    } catch (d) {
    ...
    c.done ? n(s) : Promise.resolve(s).then(o, i);
}
function _asyncToGenerator(t) {
    return function() {
        ...
        return new Promise(function(o, i) {
            var r = t.apply(n, e);
            function a(t) {
                asyncGeneratorStep(r, o, i, a, c, 'next', t);
            }
            function c(t) {
                asyncGeneratorStep(r, o, i, a, c, 'throw', t);
            }
            a(void 0);
        });
    };
