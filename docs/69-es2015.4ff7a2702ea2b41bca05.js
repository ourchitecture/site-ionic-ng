(window.webpackJsonp = window.webpackJsonp || []).push([
    [69],
    {
        k5eQ: function(t, e, o) {
            'use strict';
            o.r(e),
                o.d(e, 'ion_route', function() {
                    return s;
                }),
                o.d(e, 'ion_route_redirect', function() {
                    return a;
                }),
                o.d(e, 'ion_router', function() {
                    return P;
                }),
                o.d(e, 'ion_router_link', function() {
                    return j;
                });
            var n = o('imtE'),
                r = (o('AfW+'), o('aiEM')),
            ...
            const s = class {
                    constructor(t) {
                        Object(n.k)(this, t),
                            (this.url = ''),
                            (this.ionRouteDataChanged = Object(n.e)(
                                this,
                                'ionRouteDataChanged',
                                7
                            ));
                    ...
                    onComponentProps(t, e) {
                        ...
                        if (o.length === n.length) {
                            for (const n of o)
                                if (t[n] !== e[n]) return void this.onUpdate(t);
                ...
                a = class {
                    constructor(t) {
                        Object(n.k)(this, t),
                            (this.ionRouteRedirectChanged = Object(n.e)(
                                this,
                ...
                h = (t) => '/' + t.filter((t) => t.length > 0).join('/'),
                c = (t) => {
                    if (null == t) return [''];
                    const e = t
                        .split('/')
                ...
                l = async (t, e, o, n, r = !1) => {
                    try {
                        const i = d(t);
                        if (n >= e.length || !i) return r;
                        await i.componentOnReady();
                        const s = e[n],
                            a = await i.setRouteId(s.id, s.params, o);
                        return (
                            a.changed && ((o = 'root'), (r = !0)),
                            (r = await l(a.element, e, o, n + 1, r)),
                            a.markVisible && (await a.markVisible()),
                            r
                        );
                    } catch (i) {
                ...
                d = (t) => {
                    if (t)
                        return t.matches(u) ? t : t.querySelector(u) || void 0;
                },
                g = (t, e) =>
                    e.find((e) =>
                        ((t, e) => {
                ...
                f = (t, e) => {
                    ...
                    let n = 0;
                    for (; n < o && t[n].toLowerCase() === e[n].id; n++);
                    return n;
                },
                p = (t, e) => {
                    const o = new b(t);
            ...
            const R = (t) =>
                ...
                C = (t, e = t) =>
                    Array.from(e.children)
                        ...
                        .map((e) => {
                            const o = y(e, 'component');
                            if (null == o)
                                throw new Error(
                                    'component missing in ion-route'
                                );
                            return {
                                path: c(y(e, 'url')),
                                id: o.toLowerCase(),
                ...
                O = (t) => {
                    const e = [];
                    for (const o of t) k([], e, o);
                    return e;
                },
                k = (t, e, o) => {
                    const n = t.slice();
                    if (
                        (n.push({ id: o.id, path: o.path, params: o.params }),
                        0 !== o.children.length)
                    )
                        for (const r of o.children) k(n, e, r);
                    else e.push(n);
                },
                P = class {
                    constructor(t) {
                        Object(n.k)(this, t),
                            ...
                            (this.root = '/'),
                            (this.useHash = !0),
                            (this.ionRouteWillChange = Object(n.e)(
                                this,
                                'ionRouteWillChange',
                                7
                            )),
                            (this.ionRouteDidChange = Object(n.e)(
                                this,
                                'ionRouteDidChange',
                                7
                            ));
                    ...
                    componentDidLoad() {
                        window.addEventListener(
                            'ionRouteRedirectChanged',
                            Object(r.e)(this.onRedirectChanged.bind(this), 10)
                        ),
                            window.addEventListener(
                                'ionRouteDataChanged',
                                Object(r.e)(
                                    this.onRoutesChanged.bind(this),
                                    100
                                )
                            );
                    }
                    onPopState() {
                        ...
                        return (
                            console.debug(
                                '[ion-router] URL changed -> update nav',
                                e,
                                t
                            ),
                            this.writeNavStateRoot(e, t)
                        );
                    }
                    onBackButton(t) {
                    ...
                    push(t, e = 'forward') {
                        t.startsWith('.') &&
                            ...
                            console.debug(
                                '[ion-router] URL pushed -> updating nav',
                                t,
                                e
                            );
                        const o = c(t);
                        return this.setPath(o, e), this.writeNavStateRoot(o, e);
                    }
                    back() {
                        return (
                            window.history.back(),
                            Promise.resolve(this.waitPromise)
                        );
                    }
                    async printDebug() {
                    ...
                    async navChanged(t) {
                        ...
                        const { ids: e, outlet: o } = await (async (t) => {
                                const e = [];
                                let o,
                    ...
                    async writeNavStateRoot(t, e) {
                        ...
                        const o = R(this.el),
                            n = g(t, o);
                        let r = null;
                        n && (this.setPath(n.to, e), (r = n.from), (t = n.to));
                        const i = ((t, e) => {
                            let o = null,
                                n = 0;
                            for (const r of e) {
                        ...
                        return i
                            ? this.safeWriteNavState(document.body, i, e, t, r)
                            : (console.error(
                                  '[ion-router] the path does not match any route'
                              ),
                              !1);
                    }
                    async safeWriteNavState(t, e, o, n, r, i = 0) {
                        const s = await this.lock();
                        let a = !1;
                        try {
                            a = await this.writeNavState(t, e, o, n, r, i);
                        } catch (h) {
                            console.error(h);
                        }
                        return s(), a;
                    ...
                    async writeNavState(t, e, o, n, r, i = 0) {
                        if (this.busy)
                            return (
                                console.warn(
                        ...
                        this.busy = !0;
                        const s = this.routeChangeEvent(n, r);
                        s && this.ionRouteWillChange.emit(s);
                        const a = await l(t, e, o, i);
                        return (
                            (this.busy = !1),
                            a && console.debug('[ion-router] route changed', n),
                            s && this.ionRouteDidChange.emit(s),
                            a
                        );
                    }
                    setPath(t, e) {
                ...
                j = class {
                    constructor(t) {
                        Object(n.k)(this, t),
                            ...
                            (this.onClick = (t) => {
                                Object(i.d)(this.href, t, this.routerDirection);
                            });
                    }
                    render() {
                        const t = Object(n.d)(this),
                            e = {
                                href: this.href,
                                rel: this.rel,
                                target: this.target,
                        ...
                        return Object(n.i)(
                            n.a,
                            {
                                ...
                                class: Object.assign(
                                    Object.assign({}, Object(i.a)(this.color)),
                                    { [t]: !0, 'ion-activatable': !0 }
                                ),
                            },
                            Object(n.i)(
                                'a',
                                Object.assign({}, e),
                                Object(n.i)('slot', null)
                            )
                        );
                    }
                    static get style() {
