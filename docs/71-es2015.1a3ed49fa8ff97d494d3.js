            ...
            const s = class {
                constructor(e) {
                    Object(r.k)(this, e),
                        ...
                        (this.onInput = (e) => {
                            const a = e.target;
                            a && (this.value = a.value), this.ionInput.emit(e);
                        }),
                        (this.onBlur = () => {
                            (this.focused = !1),
                                this.ionBlur.emit(),
                        ...
                        (this.ionInput = Object(r.e)(this, 'ionInput', 7)),
                        (this.ionChange = Object(r.e)(this, 'ionChange', 7)),
                        (this.ionCancel = Object(r.e)(this, 'ionCancel', 7)),
                        (this.ionClear = Object(r.e)(this, 'ionClear', 7)),
                ...
                positionElements() {
                    const e = this.getValue(),
                        a = this.shouldAlignLeft,
                        t = Object(r.d)(this),
                        i = !this.animated || '' !== e.trim() || !!this.focused;
                    (this.shouldAlignLeft = i),
                        'ios' === t &&
                ...
                positionPlaceholder() {
                    ...
                    if (this.shouldAlignLeft)
                        e.removeAttribute('style'), t.removeAttribute('style');
                    else {
                        const r = document,
                            i = r.createElement('span');
                        (i.innerText = this.placeholder || ''),
                            r.body.appendChild(i),
                            Object(n.k)(() => {
                                const r = i.offsetWidth;
                                i.remove();
                                const n = 'calc(50% - ' + r / 2 + 'px)',
                                    o = 'calc(50% - ' + (r / 2 + 30) + 'px)';
                                a
                                    ? ((e.style.paddingRight = n),
                                      (t.style.marginRight = o))
                                    : ((e.style.paddingLeft = n),
                ...
                positionCancelButton() {
                    const e = 'rtl' === document.dir,
                        a = (this.el.shadowRoot || this.el).querySelector(
                            '.searchbar-cancel-button'
                        ),
                        t = this.shouldShowCancelButton();
                    if (a && t !== this.isCancelVisible) {
                        const r = a.style;
                        if (((this.isCancelVisible = t), t))
                            e ? (r.marginLeft = '0') : (r.marginRight = '0');
                        else {
                ...
                render() {
                    const e = this.animated && i.b.getBoolean('animated', !0),
                        a = Object(r.d)(this),
                        t =
                            this.clearIcon ||
                            ('ios' === a ? 'close-circle' : 'close-sharp'),
                        n =
                            this.searchIcon ||
                            ('ios' === a ? 'search-outline' : 'search-sharp'),
                        s =
                            'never' !== this.showCancelButton &&
                            Object(r.i)(
                                'button',
                    ...
                    return Object(r.i)(
                        r.a,
                        {
                            ...
                            class: Object.assign(
                                ...
                                {
                                    [a]: !0,
                                    'searchbar-animated': e,
                                    'searchbar-disabled': this.disabled,
                                    'searchbar-no-animate': e && this.noAnimate,
