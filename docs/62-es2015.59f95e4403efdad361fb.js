            ...
            const s = class {
                    constructor(t) {
                        Object(a.k)(this, t),
                            ...
                            (this.value = 0),
                            (this.clampBounds = (t) =>
                                Object(n.c)(this.min, t, this.max)),
                            ...
                            (this.handleKeyboard = (t, e) => {
                                ...
                                (i = i > 0 ? i : 1),
                                    ...
                                    e || (i *= -1),
                                    'A' === t
                                        ? (this.ratioA = Object(n.c)(
                                              0,
                                              this.ratioA + i,
                                              1
                                          ))
                                        : (this.ratioB = Object(n.c)(
                                              0,
                                              this.ratioB + i,
                                              1
                                          )),
                    ...
                    onStart(t) {
                        const e = (this.rect = this.rangeSlider.getBoundingClientRect()),
                            i = t.currentX;
                        let a = Object(n.c)(0, (i - e.left) / e.width, 1);
                        'rtl' === document.dir && (a = 1 - a),
                            (this.pressedKnob =
                                !this.dualKnobs ||
                                Math.abs(this.ratioA - a) <
                                    Math.abs(this.ratioB - a)
                                    ? 'A'
                                    : 'B'),
                    ...
                    update(t) {
                        const e = this.rect;
                        let i = Object(n.c)(0, (t - e.left) / e.width, 1);
                        'rtl' === document.dir && (i = 1 - i),
                            this.snaps &&
                                (i = h(
                                    d(i, this.min, this.max, this.step),
                                    this.min,
                                    this.max
                                )),
                            'A' === this.pressedKnob
                    ...
                    get valA() {
                        return d(this.ratioA, this.min, this.max, this.step);
                    }
                    get valB() {
                        return d(this.ratioB, this.min, this.max, this.step);
                    }
                    get ratioLower() {
                        return this.dualKnobs
                    ...
                    updateRatio() {
                        const t = this.getValue(),
                            { min: e, max: i } = this;
                        this.dualKnobs
                            ? ((this.ratioA = h(t.lower, e, i)),
                              (this.ratioB = h(t.upper, e, i)))
                            : (this.ratioA = h(t, e, i));
                    }
                    updateValue() {
                        this.noUpdate = !0;
                        const { valA: t, valB: e } = this;
                        (this.value = this.dualKnobs
                            ? { lower: Math.min(t, e), upper: Math.max(t, e) }
                            : t),
                            (this.noUpdate = !1);
                    }
                    setFocus(t) {
                        if (this.el.shadowRoot) {
                            const e = this.el.shadowRoot.querySelector(
                                'A' === t ? '.range-knob-a' : '.range-knob-b'
                            );
                            e && e.focus();
                        }
                    }
                    render() {
                        const {
                            ...
                            v = {
                                [k]: `${100 * c}%`,
                                [m ? 'left' : 'right']: `${100 - 100 * p}%`,
                            },
                            w = [];
                        if (this.snaps && this.ticks)
                            for (let a = t; a <= e; a += i) {
                                const i = h(a, t, e),
                                    n = { ratio: i, active: i >= c && i <= p };
                                (n[k] = `${100 * i}%`), w.push(n);
                            }
                        return (
                            Object(n.a)(
                                ...
                                a.a,
                                {
                                    ...
                                    class: Object.assign(
                                        ...
                                        ),
                                        {
                                            ...
                                            'range-disabled': b,
                                            'range-pressed': void 0 !== l,
                                            'range-has-pin': g,
                                        }
                                    ),
                                },
                                Object(a.i)('slot', { name: 'start' }),
                                Object(a.i)(
                                    'div',
                                    {
                                        class: 'range-slider',
                ...
                o = (
                    ...
                    return Object(a.i)(
                        'div',
                        {
                            onKeyDown: (t) => {
                                const i = t.key;
                                'ArrowLeft' === i || 'ArrowDown' === i
                                    ? (l(e, !1),
                                      t.preventDefault(),
                                      t.stopPropagation())
                                    : ('ArrowRight' !== i && 'ArrowUp' !== i) ||
                                      (l(e, !0),
                                      t.preventDefault(),
                                      t.stopPropagation());
                            },
                ...
                d = (t, e, i, a) => {
                    let r = (i - e) * t;
                    return (
                        a > 0 && (r = Math.round(r / a) * a + e),
                        Object(n.c)(e, r, i)
                    );
                },
                h = (t, e, i) => Object(n.c)(0, (t - e) / (i - e), 1);
        },
    },
]);
