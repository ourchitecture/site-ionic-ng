        ...
        upP9: function(t, e, i) {
            ...
            const s = class {
                    ...
                    async connectedCallback() {
                        (this.gesture = (
                            await Promise.resolve().then(i.bind(null, 'AzGJ'))
                        ).createGesture({
                            el: this.el,
                            gestureName: 'toggle',
                            gesturePriority: 100,
                    ...
                    onMove(t) {
                        d(document, this.checked, t.deltaX, -10) &&
                            ((this.checked = !this.checked), Object(a.d)());
                    }
                    onEnd(t) {
                        (this.activated = !1),
                    ...
                    render() {
                        ...
                        return (
                            l && (l.id = g),
                            Object(o.a)(!0, d, this.name, i ? h : '', e),
                            Object(n.i)(
                                n.a,
                                {
