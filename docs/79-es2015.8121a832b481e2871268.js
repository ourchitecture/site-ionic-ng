        ...
        edcM: function(i, e, t) {
            ...
            const n = {
                ...
                l = class {
                    constructor(i) {
                        Object(s.k)(this, i),
                            ...
                            (this.disabled = !1),
                            (this.when = n.lg),
                            (this.ionSplitPaneVisible = Object(s.e)(
                                this,
                                'ionSplitPaneVisible',
                                7
                            ));
                    ...
                    visibleChanged(i) {
                        ...
                        this.ionSplitPaneVisible.emit(e);
                    }
                    connectedCallback() {
                    ...
                    isPane(i) {
                        return (
                            ...
                            i.classList.contains('split-pane-side')
                        );
                    }
                    styleChildren() {
                        const i = this.contentId,
                            e = this.el.children,
                            t = this.el.childElementCount;
                        let s = !1;
                        for (let n = 0; n < t; n++) {
                            const t = e[n],
                                l = void 0 !== i && t.id === i;
                ...
                o = (i, e) => {
                    let t, s;
                    e
                        ? ((t = 'split-pane-main'), (s = 'split-pane-side'))
                        : ((t = 'split-pane-side'), (s = 'split-pane-main'));
                    const n = i.classList;
                    n.add(t), n.remove(s);
                };
        },
