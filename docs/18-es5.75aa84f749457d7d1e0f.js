...
(window.webpackJsonp = window.webpackJsonp || []).push([
    [18],
    {
        '2/RY': function(e, t, r) {
            'use strict';
            r.r(t),
                r.d(t, 'ion_alert', function() {
                    return u;
                });
            var i = r('imtE'),
                a = (r('AfW+'), r('aiEM'), r('1ym9')),
                n = (r('EV1M'), r('7TZ+')),
                o = r('Dl6n'),
                l = r('YtD4'),
                s = function(e) {
                    ...
                    function e(t) {
                        ...
                        _classCallCheck(this, e),
                            ...
                            (this.onBackdropTap = function() {
                                r.dismiss(void 0, n.a);
                            }),
                            (this.dispatchCancelHandler = function(e) {
                                var t = e.detail.role;
                                if (Object(n.j)(t)) {
                                    var i = r.processedButtons.find(function(
                                        e
                                    ) {
                                        return 'cancel' === e.role;
                                    });
                                    r.callButtonHandler(i);
                                }
                            }),
                            Object(n.e)(this.el),
                            ...
                            [
                                {
                                    key: 'buttonsChanged',
                                    value: function() {
                                        this.processedButtons = this.buttons.map(
                                            function(e) {
                                ...
                                },
                                {
                                    ...
                                    value: function() {
                                        ...
                                        r.has('checkbox') &&
                                            r.has('radio') &&
                                            console.warn(
                                                'Alert cannot mix input types: '.concat(
                                ...
                                },
                                {
                                    ...
                                    value: function(e) {
                                        ...
                                        var i = this.callButtonHandler(e, r);
                                        return !1 !== i
                                            ? this.dismiss(
                                                  Object.assign(
                                                      { values: r },
                                ...
                                },
                                {
                                    key: 'getValues',
                                    value: function() {
                                        if (0 !== this.processedInputs.length) {
                                            if ('radio' === this.inputType) {
                                                var e = this.processedInputs.find(
                                                    function(e) {
                                                        return !!e.checked;
                                                    }
                                                );
                                ...
                                },
                                {
                                    ...
                                    value: function() {
                                        var e,
                                            ...
                                            n = this.subHeader,
                                            s = Object(i.d)(this),
                                            d = 'alert-'.concat(r, '-hdr'),
                                            c = 'alert-'.concat(r, '-sub-hdr'),
                                            p = 'alert-'.concat(r, '-msg');
                                        return (
                                            void 0 !== a
                                                ? (t = d)
                                                : void 0 !== n && (t = c),
