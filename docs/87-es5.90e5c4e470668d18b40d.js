...
function _asyncToGenerator(t) {
    return function() {
        ...
        return new Promise(function(n, o) {
            var a = t.apply(e, r);
            function i(t) {
                asyncGeneratorStep(a, n, o, i, s, 'next', t);
            }
            function s(t) {
                asyncGeneratorStep(a, n, o, i, s, 'throw', t);
            }
            i(void 0);
        });
    };
...
(window.webpackJsonp = window.webpackJsonp || []).push([
    [87],
    {
        XGfm: function(t, e, r) {
            'use strict';
            r.r(e),
                r.d(e, 'ion_toast', function() {
                    return p;
                });
            var n = r('imtE'),
                o = (r('AfW+'), r('aiEM'), r('1ym9')),
                a = (r('EV1M'), r('7TZ+')),
                i = r('Dl6n'),
                s = r('YtD4'),
                c = function(t, e) {
                    var r = Object(o.a)(),
                        n = Object(o.a)(),
                        a = t.host || t,
                        i = t.querySelector('.toast-wrapper');
                    switch ((n.addElement(i), e)) {
                        case 'top':
                            n.fromTo(
                                'transform',
                                'translateY(-100%)',
                        ...
                        case 'middle':
                            var s = Math.floor(
                                a.clientHeight / 2 - i.clientHeight / 2
                            );
                            (i.style.top = ''.concat(s, 'px')),
                                n.fromTo('opacity', 0.01, 1);
                            break;
                        default:
                            n.fromTo(
                                'transform',
                ...
                u = function(t) {
                    ...
                    return (
                        r.addElement(a).fromTo('opacity', 0.99, 0),
                        e
                            .addElement(n)
                            .easing('cubic-bezier(.36,.66,.04,1)')
                            .duration(300)
                    ...
                    function t(e) {
                        ...
                        _classCallCheck(this, t),
                            ...
                            (this.dispatchCancelHandler = function(t) {
                                var e = t.detail.role;
                                if (Object(a.j)(e)) {
                                    var n = r.getButtons().find(function(t) {
                                        return 'cancel' === t.role;
                                    });
                                    r.callButtonHandler(n);
                                }
                            }),
                            Object(a.e)(this.el),
