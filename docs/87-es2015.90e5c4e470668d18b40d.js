        ...
        XGfm: function(t, o, e) {
            ...
            const d = (t, o) => {
                    ...
                    switch ((i.addElement(n), o)) {
                        ...
                        case 'middle':
                            const t = Math.floor(
                                r.clientHeight / 2 - n.clientHeight / 2
                            );
                            (n.style.top = `${t}px`),
                ...
                p = (t) => {
                    ...
                    return (
                        e.addElement(r).fromTo('opacity', 0.99, 0),
                        o
                            .addElement(i)
                            .easing('cubic-bezier(.36,.66,.04,1)')
                            .duration(300)
                ...
                b = class {
                    ...
                    onDidDismiss() {
                        return Object(r.h)(this.el, 'ionToastDidDismiss');
                    }
                    onWillDismiss() {
                        return Object(r.h)(this.el, 'ionToastWillDismiss');
                    }
                    getButtons() {
                        return this.buttons
                            ? this.buttons.map((t) =>
                    ...
                    async callButtonHandler(t) {
                        if (t && t.handler)
                            try {
                                if (!1 === (await Object(r.n)(t.handler)))
                                    return !1;
                            } catch (o) {
                                console.error(o);
                            }
