...
function asyncGeneratorStep(e, t, o, r, i, n, a) {
    try {
        var s = e[n](a),
            p = s.value;
    } catch (c) {
    ...
    s.done ? t(p) : Promise.resolve(p).then(r, i);
}
function _asyncToGenerator(e) {
    return function() {
        ...
        return new Promise(function(r, i) {
            var n = e.apply(t, o);
            function a(e) {
                asyncGeneratorStep(n, r, i, a, s, 'next', e);
            }
            function s(e) {
                asyncGeneratorStep(n, r, i, a, s, 'throw', e);
            }
            a(void 0);
        });
    };
        ...
        Gdks: function(e, t, o) {
            ...
            var r = o('imtE'),
                ...
                c = function(e, t) {
                    var o = 'top',
                        r = 'left',
                        n = e.querySelector('.popover-content'),
                        ...
                        v = null != u && 'top' in u ? u.top : d / 2 - p / 2,
                        f = null != u && 'left' in u ? u.left : c / 2,
                        h = (u && u.width) || 0,
                        b = (u && u.height) || 0,
                        m = e.querySelector('.popover-arrow'),
                        y = m.getBoundingClientRect(),
                        w = y.width,
                        g = y.height;
                    null == u && (m.style.display = 'none');
                    var x = { top: v + b, left: f + h / 2 - w / 2 },
                        k = { top: v + b + (g - 1), left: f + h / 2 - s / 2 },
                        j = !1,
                        O = !1;
                    k.left < l + 25
                        ? ((j = !0), (k.left = l))
                        ...
                        v + b + p > d && v - p > 0
                            ? ((x.top = v - (g + 1)),
                              ...
                              (o = 'bottom'))
                            : v + b + p > d && (n.style.bottom = l + '%'),
                        (m.style.top = x.top + 'px'),
                        (m.style.left = x.left + 'px'),
                        (n.style.top = k.top + 'px'),
                        (n.style.left = k.left + 'px'),
                        j &&
                            (n.style.left = 'calc('.concat(
                                k.left,
                ...
                u = function(e, t) {
                    var o = e.ownerDocument,
                        ...
                        v = t && t.target && t.target.getBoundingClientRect(),
                        f =
                            null != v && 'bottom' in v
                                ? v.bottom
                                : u / 2 - l / 2,
                    ...
                    b.left < 12
                        ? ((b.left = 12), (a = 'left'))
                        : c + 12 + b.left > d &&
                          ((b.left = d - c - 12), (a = 'right')),
                        f + h + l > u && f - l > 0
                            ? ((b.top = f - l - h),
                              (e.className = e.className + ' popover-bottom'),
                              (n = 'bottom'))
                            : f + h + l > u && (s.style.bottom = '12px');
                    var m = Object(i.a)(),
                        y = Object(i.a)(),
                        w = Object(i.a)(),
                        g = Object(i.a)(),
