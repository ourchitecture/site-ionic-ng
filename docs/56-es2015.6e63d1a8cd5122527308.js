(window.webpackJsonp = window.webpackJsonp || []).push([
    [56],
    {
        Gdks: function(e, o, t) {
            'use strict';
            t.r(o),
                t.d(o, 'ion_popover', function() {
                    return b;
                });
            var i = t('imtE'),
                r = (t('AfW+'), t('aiEM'), t('1ym9')),
                s = (t('kBU6'), t('EV1M'), t('7TZ+')),
                n = t('Dl6n'),
                a = t('m9yc'),
                p = t('9qPz');
            const l = (e, o) => {
                    let t = 'top',
                        i = 'left';
                    const s = e.querySelector('.popover-content'),
                        n = s.getBoundingClientRect(),
                        a = n.width,
                        p = n.height,
                        l = e.ownerDocument.defaultView.innerWidth,
                        d = e.ownerDocument.defaultView.innerHeight,
                        h = o && o.target && o.target.getBoundingClientRect(),
                        v = null != h && 'top' in h ? h.top : d / 2 - p / 2,
                    ...
                    const x = { top: v + f, left: b + m / 2 - g / 2 },
                        k = { top: v + f + (y - 1), left: b + m / 2 - a / 2 };
                    let j = !1,
                        O = !1;
                    k.left < c + 25
                        ? ((j = !0), (k.left = c))
                        : a + c + k.left + 25 > l &&
                          ((O = !0), (k.left = l - a - c), (i = 'right')),
                        v + f + p > d && v - p > 0
                            ? ((x.top = v - (y + 1)),
                              (k.top = v - p - (y - 1)),
                              (e.className = e.className + ' popover-bottom'),
                              (t = 'bottom'))
                            : v + f + p > d && (s.style.bottom = c + '%'),
                        (u.style.top = x.top + 'px'),
                        (u.style.left = x.left + 'px'),
                        (s.style.top = k.top + 'px'),
                        (s.style.left = k.left + 'px'),
                        j &&
                            (s.style.left = `calc(${k.left}px + var(--ion-safe-area-left, 0px))`),
                        O &&
                            (s.style.left = `calc(${k.left}px - var(--ion-safe-area-right, 0px))`),
                        (s.style.transformOrigin = t + ' ' + i);
                    const D = Object(r.a)(),
                        E = Object(r.a)(),
                        P = Object(r.a)();
                    return (
                ...
                h = (e, o) => {
                    ...
                    const a = e.querySelector('.popover-content'),
                        ...
                        l = p.width,
                        c = p.height,
                        d = t.defaultView.innerWidth,
                        h = t.defaultView.innerHeight,
                        v = o && o.target && o.target.getBoundingClientRect(),
                        b =
                            null != v && 'bottom' in v
                                ? v.bottom
                                : h / 2 - c / 2,
                    ...
                    f.left < 12
                        ? ((f.left = 12), (n = 'left'))
                        : l + 12 + f.left > d &&
                          ((f.left = d - l - 12), (n = 'right')),
                        b + m + c > h && b - c > 0
                            ? ((f.top = b - c - m),
                              (e.className = e.className + ' popover-bottom'),
                              (s = 'bottom'))
                            : b + m + c > h && (a.style.bottom = '12px');
                    const u = Object(r.a)(),
                        w = Object(r.a)(),
                        g = Object(r.a)(),
                        y = Object(r.a)(),
                ...
                b = class {
                    ...
                    async present() {
                        ...
                        return (
                            ...
                            Object(s.f)(this, 'popoverEnter', l, h, this.event)
                        );
                    }
                    async dismiss(e, o) {
                        const t = await Object(s.g)(
                            this,
                            e,
                            o,
                            'popoverLeave',
                    ...
                    onDidDismiss() {
                        return Object(s.h)(this.el, 'ionPopoverDidDismiss');
                    }
                    onWillDismiss() {
                        return Object(s.h)(this.el, 'ionPopoverWillDismiss');
                    }
                    render() {
