...
function asyncGeneratorStep(t, e, n, r, i, a, o) {
    try {
        var s = t[a](o),
            c = s.value;
    } catch (d) {
...
function _asyncToGenerator(t) {
    return function() {
        ...
        return new Promise(function(r, i) {
            var a = t.apply(e, n);
            function o(t) {
                asyncGeneratorStep(a, r, i, o, s, 'next', t);
            }
            function s(t) {
                asyncGeneratorStep(a, r, i, o, s, 'throw', t);
            }
            o(void 0);
        });
    };
...
(window.webpackJsonp = window.webpackJsonp || []).push([
    [88],
    {
        'Y/uG': function(t, e, n) {
            'use strict';
            n.r(e),
                n.d(e, 'ion_toast', function() {
                    return p;
                });
            var r = n('imtE'),
                i = (n('AfW+'), n('aiEM'), n('1ym9')),
                a = (n('EV1M'), n('7TZ+')),
                o = n('Dl6n'),
                s = n('YtD4'),
                c = function(t, e) {
                    var n = Object(i.a)(),
                        r = Object(i.a)(),
                        a = t.host || t,
                        o = t.querySelector('.toast-wrapper');
                    switch ((r.addElement(o), e)) {
                        case 'top':
                            r.fromTo(
                                'transform',
                                'translateY(-100%)',
                                'translateY(calc(10px + var(--ion-safe-area-top, 0px)))'
                            );
                            break;
                        case 'middle':
                            var s = Math.floor(
                                a.clientHeight / 2 - o.clientHeight / 2
                            );
                            (o.style.top = ''.concat(s, 'px')),
                        ...
                        default:
                            r.fromTo(
                                'transform',
                                'translateY(100%)',
                                'translateY(calc(-10px - var(--ion-safe-area-bottom, 0px)))'
                            );
                    }
                    return n
                        .addElement(a)
                ...
                l = function(t, e) {
                    ...
                    switch ((r.addElement(o), e)) {
                        case 'top':
                            (o.style.top =
                                'calc(8px + var(--ion-safe-area-top, 0px))'),
                                r.fromTo('opacity', 0.01, 1);
                            break;
                        case 'middle':
                            var s = Math.floor(
                        ...
                        default:
                            (o.style.bottom =
                                'calc(8px + var(--ion-safe-area-bottom, 0px))'),
                                r.fromTo('opacity', 0.01, 1);
                    }
                    return n
                        .addElement(a)
                ...
                u = function(t) {
                    var e = Object(i.a)(),
                        n = Object(i.a)(),
                        r = t.host || t,
                        a = t.querySelector('.toast-wrapper');
                    return (
                        n.addElement(a).fromTo('opacity', 0.99, 0),
                        e
                            .addElement(r)
                            .easing('cubic-bezier(.36,.66,.04,1)')
                            .duration(300)
                    ...
                    function t(e) {
                        ...
                        _classCallCheck(this, t),
                            ...
                            (this.dispatchCancelHandler = function(t) {
                                var e = t.detail.role;
                                if (Object(a.j)(e)) {
                                    var r = n.getButtons().find(function(t) {
                                        return 'cancel' === t.role;
                                    });
                                    n.callButtonHandler(r);
                                }
                            }),
                            Object(a.e)(this.el),
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function(t, e) {
                                        var n = this;
                                        if (0 !== t.length) {
                                            var i = Object(r.d)(this),
                                                a = _defineProperty(
                                                    {
                                                        'toast-button-group': !0,
                                                    },
                                                    'toast-button-group-'.concat(
                                                        e
                                                    ),
                                                    !0
                                                );
                                        ...
                                        return Object(r.i)(
                                            r.a,
                                            {
                                                ...
                                                class: Object.assign(
                                                    ...
                                                    {
                                                        'toast-translucent': this
                                                            .translucent,
                                                    }
                                                ),
                                                onIonToastWillDismiss: this
                ...
                b = function(t) {
                    ...
                    return Object.assign(
                        (_defineProperty(
                            ...
                            'toast-button-'.concat(t.role),
                            void 0 !== t.role
                        ),
                        _defineProperty(e, 'ion-focusable', !0),
                        _defineProperty(e, 'ion-activatable', !0),
                        e),
                        Object(o.b)(t.cssClass)
                    );
                };
        },
    },
