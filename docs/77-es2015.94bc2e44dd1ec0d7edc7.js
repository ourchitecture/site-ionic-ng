(window.webpackJsonp = window.webpackJsonp || []).push([
    [77],
    {
        k8us: function(i, e, t) {
            'use strict';
            t.r(e),
                t.d(e, 'ion_slide', function() {
                    return n;
                }),
                t.d(e, 'ion_slides', function() {
                    return a;
                });
            var r = t('imtE');
            t('AfW+');
            const n = class {
                ...
                a = class {
                    ...
                    async optionsChanged() {
                        if (this.swiperReady) {
                            ...
                            Object.assign(i.params, this.options),
                                await this.update();
                        }
                    }
                    connectedCallback() {
                    ...
                    async disconnectedCallback() {
                        this.mutationO &&
                            ...
                            (await this.getSwiper()).destroy(!0, !0),
                            (this.swiper = new Promise((i) => {
                                this.readySwiper = i;
                            })),
                            (this.swiperReady = !1);
                    ...
                    async initSwiper() {
                        const i = this.normalizeOptions(),
                            { Swiper: e } = await t
                                .e(6)
                                .then(t.bind(null, 'E+Ut'));
                        await s(this.el);
                        const r = new e(this.el, i);
                        (this.swiperReady = !0), this.readySwiper(r);
                    }
                    normalizeOptions() {
                        const i = {
                            effect: void 0,
                        ...
                        const e = {
                                on: {
                                    ...
                                    slideNextTransitionEnd: this.ionSlideNextEnd
                                        .emit,
                                    slidePrevTransitionEnd: this.ionSlidePrevEnd
                                        .emit,
                                    transitionStart: this
                                        .ionSlideTransitionStart.emit,
                                    transitionEnd: this.ionSlideTransitionEnd
                                        .emit,
                                    sliderMove: this.ionSlideDrag.emit,
                                    reachBeginning: this.ionSlideReachStart
                                        .emit,
                        ...
                        return Object.assign(
                            Object.assign(Object.assign({}, i), this.options),
                            t
                        );
                    }
                    render() {
                ...
                s = (i) =>
                    Promise.all(
                        Array.from(i.querySelectorAll('ion-slide')).map((i) =>
                            i.componentOnReady()
                        )
                    );
        },
