...
(window.webpackJsonp = window.webpackJsonp || []).push([
    [58],
    {
        '0PGG': function(e, i, t) {
            'use strict';
            t.r(i),
                t.d(i, 'ion_progress_bar', function() {
                    return o;
                });
            var r = t('imtE'),
                n = t('AfW+'),
                ...
                b = function(e, i) {
                    var t = Object(a.c)(0, e, 1),
                        n = Object(a.c)(0, i, 1);
                    return [
                        Object(r.i)('div', {
                            class: 'progress',
                            style: { transform: 'scaleX('.concat(t, ')') },
                        }),
                        1 !== n &&
                            Object(r.i)('div', { class: 'buffer-circles' }),
                        Object(r.i)('div', {
                            class: 'progress-buffer-bar',
                            style: { transform: 'scaleX('.concat(n, ')') },
                        }),
                    ];
                };
        },
