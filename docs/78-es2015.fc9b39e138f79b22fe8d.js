(window.webpackJsonp = window.webpackJsonp || []).push([
    [78],
    {
        nI0H: function(t, e, r) {
            ...
            const o = class {
                    constructor(t) {
                        Object(n.k)(this, t), (this.paused = !1);
                    }
                    getName() {
                        const t = this.name || s.b.get('spinner'),
                            e = Object(n.d)(this);
                        return t || ('ios' === e ? 'lines' : 'circular');
                    }
                    render() {
                        const t = Object(n.d)(this),
                            ...
                            p = [];
                        if (void 0 !== r.circles)
                            for (let n = 0; n < r.circles; n++)
                                p.push(l(r, o, n, r.circles));
                        else if (void 0 !== r.lines)
                            for (let n = 0; n < r.lines; n++)
                                p.push(c(r, o, n, r.lines));
                        return Object(n.i)(
                            n.a,
                            {
                                class: Object.assign(
