            ...
            const p = (e, t) => {
                                ...
                                .keyframes([
                                    {
                                        offset: 0,
                                        filter: 'contrast(0.85)',
                                        transform: `translateY(${o}) scale(${a})`,
                                        borderRadius: '10px 10px 0 0',
                                    },
                                    {
                                        offset: 1,
                ...
                u = (e) => {
                    const t = Object(r.a)(),
                        o = Object(r.a)(),
                        i = Object(r.a)(),
                        a = e.querySelector('.modal-wrapper');
                    return (
                        o
                            .addElement(e.querySelector('ion-backdrop'))
                            .fromTo('opacity', 'var(--backdrop-opacity)', 0),
                        i.addElement(a).keyframes([
                            {
                                offset: 0,
                                opacity: 0.99,
                                transform: 'translateY(0px)',
                ...
                y = class {
                    ...
                    async present() {
                        ...
                        (this.usersElement = await Object(m.a)(
                            ...
                            await Object(h.a)(this.usersElement),
                            await Object(l.f)(
                                this,
                                'modalEnter',
                                p,
                        ...
                        const o = Object(i.d)(this);
                        if (this.swipeToClose && 'ios' === o) {
                            const e =
                                    this.leaveAnimation ||
                                    a.b.get('modalLeave', b),
                                t = (this.animation = e(
                                    this.el,
                                    this.presentingElement
                                ));
                            (this.gesture = ((e, t, o) => {
                                ...
                                let a = !1;
                                const r = Object(d.createGesture)({
                                    el: e,
                                    ...
                                    canStart: (e) => {
                                        ...
                                        return (
                                            null === t ||
                                            !t.closest ||
                                            null === t.closest('ion-content')
                                        );
                                    },
                                    onStart: () => {
                                        t.progressStart(!0, a ? 1 : 0);
                                    },
                                    onMove: (e) => {
                                        const o = e.deltaY / i;
                                        o < 0 || t.progressStep(o);
                                    },
                                    onEnd: (e) => {
                                        const d = e.velocityY,
                                            l = e.deltaY / i;
                    ...
                    async dismiss(e, t) {
                        if (this.gestureAnimationDismissing && 'gesture' !== t)
                            return !1;
                        const o = l.i.get(this) || [],
                            i = await Object(l.g)(
                                this,
                                e,
                                t,
                    ...
                    onDidDismiss() {
                        return Object(l.h)(this.el, 'ionModalDidDismiss');
                    }
                    onWillDismiss() {
                        return Object(l.h)(this.el, 'ionModalWillDismiss');
                    }
                    render() {
                                ...
                                class: Object.assign(
                                    {
                                        [e]: !0,
                                        'modal-card':
                                            void 0 !== this.presentingElement &&
                                            'ios' === e,
                                    },
                                    Object(c.b)(this.cssClass)
                                ),
