            ...
            const s = class {
                    constructor(t) {
                        Object(n.k)(this, t),
                            ...
                            (this.value = 0),
                            (this.clampBounds = (t) =>
                                Object(a.c)(this.min, t, this.max)),
                            ...
                            (this.handleKeyboard = (t, e) => {
                                ...
                                (i = i > 0 ? i : 1),
                                    ...
                                    e || (i *= -1),
                                    'A' === t
                                        ? (this.ratioA = Object(a.c)(
                                              0,
                                              this.ratioA + i,
                                              1
                                          ))
                                        : (this.ratioB = Object(a.c)(
                                              0,
                                              this.ratioB + i,
                                              1
                                          )),
                    ...
                    onStart(t) {
                        const e = (this.rect = this.rangeSlider.getBoundingClientRect()),
                            i = t.currentX;
                        let n = Object(a.c)(0, (i - e.left) / e.width, 1);
                        'rtl' === document.dir && (n = 1 - n),
                            (this.pressedKnob =
                                !this.dualKnobs ||
                                Math.abs(this.ratioA - n) <
                                    Math.abs(this.ratioB - n)
                                    ? 'A'
                                    : 'B'),
                    ...
                    update(t) {
                        const e = this.rect;
                        let i = Object(a.c)(0, (t - e.left) / e.width, 1);
                        'rtl' === document.dir && (i = 1 - i),
                            this.snaps &&
                                (i = d(
                                    l(i, this.min, this.max, this.step),
                                    this.min,
                                    this.max
                                )),
                            'A' === this.pressedKnob
                    ...
                    get valA() {
                        return l(this.ratioA, this.min, this.max, this.step);
                    }
                    get valB() {
                        return l(this.ratioB, this.min, this.max, this.step);
                    }
                    get ratioLower() {
                        return this.dualKnobs
                    ...
                    updateRatio() {
                        const t = this.getValue(),
                            { min: e, max: i } = this;
                        this.dualKnobs
                            ? ((this.ratioA = d(t.lower, e, i)),
                              (this.ratioB = d(t.upper, e, i)))
                            : (this.ratioA = d(t, e, i));
                    }
                    updateValue() {
                        this.noUpdate = !0;
                ...
                l = (t, e, i, n) => {
                    let r = (i - e) * t;
                    return (
                        n > 0 && (r = Math.round(r / n) * n + e),
                        Object(a.c)(e, r, i)
                    );
                },
                d = (t, e, i) => Object(a.c)(0, (t - e) / (i - e), 1);
        },
    },
]);
