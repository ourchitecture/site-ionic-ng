...
function _asyncToGenerator(t) {
    return function() {
        ...
        return new Promise(function(n, o) {
            var a = t.apply(e, r);
            function i(t) {
                asyncGeneratorStep(a, n, o, i, u, 'next', t);
            }
            function u(t) {
                asyncGeneratorStep(a, n, o, i, u, 'throw', t);
            }
            i(void 0);
        });
    };
...
(window.webpackJsonp = window.webpackJsonp || []).push([
    [69],
    {
        k5eQ: function(t, e, r) {
            'use strict';
            r.r(e),
                r.d(e, 'ion_route', function() {
                    return i;
                }),
                r.d(e, 'ion_route_redirect', function() {
                    return u;
                }),
                r.d(e, 'ion_router', function() {
                    return _;
                }),
                r.d(e, 'ion_router_link', function() {
                    return S;
                });
            var n = r('imtE'),
                o = (r('AfW+'), r('aiEM')),
                ...
                f = function(t) {
                    if (t)
                        return t.matches(h) ? t : t.querySelector(h) || void 0;
                },
                d = function(t, e) {
                    return e.find(function(e) {
                        return (function(t, e) {
                            var r = e.from;
                            if (void 0 === e.to) return !1;
                ...
                v = function(t, e) {
                    for (
                        var r = Math.min(t.length, e.length), n = 0;
                        n < r && t[n].toLowerCase() === e[n].id;
                        n++
                    );
                    return n;
                },
                ...
                g = function(t) {
                    ...
                    try {
                        for (
                            ...
                            try {
                                for (
                                    var f, d = c.path[Symbol.iterator]();
                                    !(s = (f = d.next()).done);
                                    s = !0
                                ) {
                                    var v = f.value;
                ...
                m = (function() {
                    function t(e) {
                        _classCallCheck(this, t), (this.path = e.slice());
                    }
                    return (
                        _createClass(t, [
                            {
                ...
                b = function(t) {
                    return Array.from(t.children)
                        .filter(function(t) {
                            return 'ION-ROUTE-REDIRECT' === t.tagName;
                        })
                        .map(function(t) {
                            var e = R(t, 'to');
                            return {
                                from: s(R(t, 'from')),
                                to: null == e ? void 0 : s(e),
                            };
                        });
                },
                w = function(t) {
                ...
                k = function t(e) {
                    ...
                    return Array.from(r.children)
                        .filter(function(t) {
                            return 'ION-ROUTE' === t.tagName && t.component;
                        })
                        .map(function(r) {
                            var n = R(r, 'component');
                            if (null == n)
                ...
                x = function t(e, r, n) {
                    var o = e.slice();
                    if (
                        (o.push({ id: n.id, path: n.path, params: n.params }),
                        0 !== n.children.length)
                    ) {
                        var a = !0,
                            i = !1,
                        ...
                        try {
                            for (
                                var c, s = n.children[Symbol.iterator]();
                                !(a = (c = s.next()).done);
                                a = !0
                            ) {
                                t(o, r, c.value);
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    window.addEventListener(
                                        'ionRouteRedirectChanged',
                                        Object(o.e)(
                                            this.onRedirectChanged.bind(this),
                                            10
                                        )
                                    ),
                                        window.addEventListener(
                                ...
                                value: function(t) {
                                    var e =
                                        ...
                                        void 0 !== arguments[1]
                                            ...
                                            : 'forward';
                                    t.startsWith('.') &&
                                        (t = new URL(t, window.location.href)
                                            .pathname),
                                        console.debug(
                                                    ...
                                                    for (;;)
                                                        switch (
                                                            ...
                                                            case 3:
                                                                return (
                                                                    (this.busy = !0),
                                                                    (u = this.routeChangeEvent(
                                                                        o,
                                                                        a
                                                                    )) &&
                                                                        this.ionRouteWillChange.emit(
                                                                            u
                                                                        ),
                                                                    (t.next = 8),
                                                                    l(
                    ...
                    function t(e) {
                        ...
                        _classCallCheck(this, t),
                            ...
                            (this.onClick = function(t) {
                                Object(a.d)(r.href, t, r.routerDirection);
                            });
                    }
                    return (
                        _createClass(
