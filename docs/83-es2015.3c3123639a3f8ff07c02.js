(window.webpackJsonp = window.webpackJsonp || []).push([
    [83],
    {
        TpdJ: function(t, e, i) {
            'use strict';
            i.r(e),
                i.d(e, 'ion_tab', function() {
                    return a;
                }),
                i.d(e, 'ion_tabs', function() {
                    return o;
                });
            var s = i('imtE'),
                n = (i('AfW+'), i('m9yc'));
            const a = class {
                    ...
                    async componentWillLoad() {
                        this.active && (await this.setActive());
                    }
                    async setActive() {
                ...
                o = class {
                    constructor(t) {
                        Object(s.k)(this, t),
                            ...
                            (this.useRouter = !1),
                            (this.onTabClicked = (t) => {
                                const { href: e, tab: i } = t.detail;
                                if (this.useRouter && void 0 !== e) {
                            ...
                            (this.ionTabsWillChange = Object(s.e)(
                                this,
                                'ionTabsWillChange',
                                3
                            )),
                            (this.ionTabsDidChange = Object(s.e)(
                                this,
                                'ionTabsDidChange',
                                3
                            ));
                    ...
                    async componentWillLoad() {
                        if (
                            ...
                            const t = this.tabs;
                            t.length > 0 && (await this.select(t[0]));
                        }
                    ...
                    async getTab(t) {
                        return r(this.tabs, t);
                    }
                    getSelected() {
                        return Promise.resolve(
                            this.selectedTab ? this.selectedTab.tab : void 0
                        );
                    }
                    async setRouteId(t) {
                        const e = r(this.tabs, t);
                        return this.shouldSwitch(e)
                            ? (await this.setActive(e),
                              {
                                  changed: !0,
                    ...
                    render() {
                        return Object(s.i)(
                            ...
                            Object(s.i)('slot', { name: 'top' }),
                            Object(s.i)(
                                'div',
                                { class: 'tabs-inner' },
                                Object(s.i)('slot', null)
                            ),
                            Object(s.i)('slot', { name: 'bottom' })
                        );
                    }
                    get el() {
                        return Object(s.f)(this);
                ...
                r = (t, e) => {
                    const i =
                        'string' == typeof e ? t.find((t) => t.tab === e) : e;
                    return (
                        i ||
