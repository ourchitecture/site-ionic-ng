(window.webpackJsonp = window.webpackJsonp || []).push([
    [88],
    {
        'Y/uG': function(t, i, e) {
            'use strict';
            e.r(i),
                e.d(i, 'ion_toast', function() {
                    return b;
                });
            var o = e('imtE'),
                a = (e('AfW+'), e('aiEM'), e('1ym9')),
                n = (e('EV1M'), e('7TZ+')),
                r = e('Dl6n'),
                s = e('YtD4');
            const d = (t, i) => {
                    ...
                    switch ((o.addElement(r), i)) {
                        ...
                        case 'middle':
                            const t = Math.floor(
                                n.clientHeight / 2 - r.clientHeight / 2
                            );
                            (r.style.top = `${t}px`),
                ...
                p = (t) => {
                    ...
                    return (
                        e.addElement(n).fromTo('opacity', 0.99, 0),
                        i
                            .addElement(o)
                            .easing('cubic-bezier(.36,.66,.04,1)')
                            .duration(300)
                ...
                b = class {
                    constructor(t) {
                        Object(o.k)(this, t),
                            ...
                            (this.dispatchCancelHandler = (t) => {
                                const i = t.detail.role;
                                if (Object(n.j)(i)) {
                                    const t = this.getButtons().find(
                                        (t) => 'cancel' === t.role
                                    );
                    ...
                    onDidDismiss() {
                        return Object(n.h)(this.el, 'ionToastDidDismiss');
                    }
                    onWillDismiss() {
                        return Object(n.h)(this.el, 'ionToastWillDismiss');
                    }
                    getButtons() {
                        return this.buttons
                            ? this.buttons.map((t) =>
                                  'string' == typeof t ? { text: t } : t
                              )
                            : [];
                    }
                    async buttonClick(t) {
                    ...
                    async callButtonHandler(t) {
                        if (t && t.handler)
                            try {
                                if (!1 === (await Object(n.n)(t.handler)))
                                    return !1;
                            } catch (i) {
                                console.error(i);
                            }
