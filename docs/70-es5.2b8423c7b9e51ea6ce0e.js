...
function asyncGeneratorStep(e, a, o, r, i, n, t) {
    try {
        var s = e[n](t),
            c = s.value;
    } catch (h) {
    ...
    s.done ? a(c) : Promise.resolve(c).then(r, i);
}
function _asyncToGenerator(e) {
    return function() {
        ...
        return new Promise(function(r, i) {
            var n = e.apply(a, o);
            function t(e) {
                asyncGeneratorStep(n, r, i, t, s, 'next', e);
            }
            function s(e) {
                asyncGeneratorStep(n, r, i, t, s, 'throw', e);
            }
            t(void 0);
        });
    };
                        ...
                        _classCallCheck(this, e),
                            ...
                            (this.onCancelSearchbar = function(e) {
                                e && (e.preventDefault(), e.stopPropagation()),
                                    o.ionCancel.emit(),
                                    o.onClearInput(),
                                    o.nativeInput && o.nativeInput.blur();
                            }),
                            (this.onInput = function(e) {
                                var a = e.target;
                                a && (o.value = a.value), o.ionInput.emit(e);
                            }),
                                ...
                                },
                                {
                                    ...
                                    value: function() {
                                        var e = 'rtl' === document.dir,
                                            a = (
                                                this.el.shadowRoot || this.el
                                            ).querySelector(
                                                '.searchbar-cancel-button'
                                            ),
                                            o = this.shouldShowCancelButton();
                                        if (a && o !== this.isCancelVisible) {
                                            var r = a.style;
                                            if (((this.isCancelVisible = o), o))
                                                e
                                                    ? (r.marginLeft = '0')
                                                    : (r.marginRight = '0');
                                            else {
                                        ...
                                        return Object(r.i)(
                                            r.a,
                                            {
                                                ...
                                                class: Object.assign(
                                                    Object.assign(
                                                        {},
                                                        Object(t.a)(this.color)
                                                    ),
                                                    ((e = {}),
                                                    _defineProperty(e, n, !0),
                                                    _defineProperty(
                                                        e,
                                                        'searchbar-animated',
                                                        o
