            ...
            const s = class {
                constructor(a) {
                    Object(i.k)(this, a),
                        ...
                        (this.onInput = (a) => {
                            const o = a.target;
                            o && (this.value = o.value), this.ionInput.emit(a);
                        }),
                        (this.onBlur = () => {
                            (this.focused = !1),
                                this.ionBlur.emit(),
                        ...
                        (this.ionInput = Object(i.e)(this, 'ionInput', 7)),
                        (this.ionChange = Object(i.e)(this, 'ionChange', 7)),
                        (this.ionCancel = Object(i.e)(this, 'ionCancel', 7)),
                        (this.ionClear = Object(i.e)(this, 'ionClear', 7)),
                        (this.ionBlur = Object(i.e)(this, 'ionBlur', 7)),
                        (this.ionFocus = Object(i.e)(this, 'ionFocus', 7)),
                        (this.ionStyle = Object(i.e)(this, 'ionStyle', 7));
                }
                debounceChanged() {
                    this.ionChange = Object(t.d)(this.ionChange, this.debounce);
                }
                valueChanged() {
                ...
                emitStyle() {
                    this.ionStyle.emit({ searchbar: !0 });
                }
                async setFocus() {
                ...
                positionElements() {
                    const a = this.getValue(),
                        o = this.shouldAlignLeft,
                        e = Object(i.d)(this),
                        r = !this.animated || '' !== a.trim() || !!this.focused;
                    (this.shouldAlignLeft = r),
                        'ios' === e &&
                            (o !== r && this.positionPlaceholder(),
                ...
                positionPlaceholder() {
                    ...
                    const o = 'rtl' === document.dir,
                        e = (this.el.shadowRoot || this.el).querySelector(
                    ...
                    if (this.shouldAlignLeft)
                        ...
                        (r.innerText = this.placeholder || ''),
                            i.body.appendChild(r),
                            Object(t.k)(() => {
                                const i = r.offsetWidth;
                                r.remove();
                                const t = 'calc(50% - ' + i / 2 + 'px)',
                                    n = 'calc(50% - ' + (i / 2 + 30) + 'px)';
                                o
                                    ? ((a.style.paddingRight = t),
                                      (e.style.marginRight = n))
                                    : ((a.style.paddingLeft = t),
                ...
                positionCancelButton() {
                    const a = 'rtl' === document.dir,
                        o = (this.el.shadowRoot || this.el).querySelector(
                            '.searchbar-cancel-button'
                        ),
                        e = this.shouldShowCancelButton();
                    if (o && e !== this.isCancelVisible) {
                        const i = o.style;
                        if (((this.isCancelVisible = e), e))
                            a ? (i.marginLeft = '0') : (i.marginRight = '0');
                        else {
                ...
                shouldShowCancelButton() {
                    return !(
                        'never' === this.showCancelButton ||
                        ('focus' === this.showCancelButton && !this.focused)
                    );
                }
                render() {
                    const a = this.animated && r.b.getBoolean('animated', !0),
                        o = Object(i.d)(this),
                        e =
                            this.clearIcon ||
                            ('ios' === o ? 'close-circle' : 'close-sharp'),
                        t =
                            this.searchIcon ||
                            ('ios' === o ? 'search-outline' : 'search-sharp'),
                        s =
                            'never' !== this.showCancelButton &&
                            Object(i.i)(
                                'button',
                    ...
                    return Object(i.i)(
                        i.a,
                        {
                            ...
                            class: Object.assign(
                                Object.assign({}, Object(n.a)(this.color)),
                                {
                                    [o]: !0,
