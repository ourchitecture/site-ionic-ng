    ...
    [11],
    {
        '5rwq': function(t, e) {
            ...
            function m(t, e, r) {
                ...
                var s = n.propName,
                    o = null != n.fallback ? b(n.fallback) : void 0;
                return (
                    e.push(t.substring(r, n.start), function(t) {
                        return (function(t, e, r) {
                            return t[e] ? t[e] : r ? g(r, t) : '';
                        })(t, s, o);
                    }),
                    n.end
                );
            ...
            var x = /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gm;
            function M(t) {
                var e = (t = t.replace(/\s+/gim, ' ').trim()).endsWith(
                    '!important'
                );
                return (
                    e &&
                        (t = t
                            .substr(0, t.length - '!important'.length)
                            .trim()),
                    { value: t, important: e }
                );
            }
            ...
            function C(t) {
                var e,
                    p = (function t(e, r) {
                        var a = r.substring(e.start, e.end - 1);
                        if (
                            ((e.parsedCssText = e.cssText = a.trim()), e.parent)
                        ) {
                            a = (a = (a = (function(t) {
                                return t.replace(
                                    /\\([0-9a-f]{1,6})\s/gi,
                            ...
                            var u = (e.parsedSelector = e.selector = a.trim());
                            (e.atRule = 0 === u.indexOf('@')),
                                e.atRule
                                    ? 0 === u.indexOf('@media')
                                        ? (e.type = o)
                                        : u.match(c) &&
                                          ...
                                          (e.keyframesName = e.selector
                                              .split(l)
                                              .pop()))
                                    : (e.type = 0 === u.indexOf('--') ? i : n);
                        }
                        var p = e.rules;
                        if (p)
                            for (
                                var f = 0, h = p.length, d = void 0;
                                f < h && (d = p[f]);
                                f++
                            )
                                t(d, r);
                        ...
                        (function(t) {
                            ...
                            for (var n = e, s = 0, o = t.length; s < o; s++)
                                if ('{' === t[s]) {
                                    n.rules || (n.rules = []);
                                    var i = n,
                                    ...
                                    '}' === t[s] &&
                                        ((n.end = s + 1), (n = n.parent || e));
                            return e;
                        })((e = (e = t).replace(a, '').replace(u, ''))),
                        e
                    ),
                    f = b(t);
                return {
            ...
            function k(t, e) {
                if (
                    ...
                    return !1;
                var r = C(e.textContent);
                return (r.styleEl = e), t.push(r), !0;
            }
            function I(t) {
                var e = S(E(t));
                t.forEach(function(t) {
                    t.usesCssVars && (t.styleEl.textContent = g(t.template, e));
                });
            }
            function O(t, e, r) {
                var n;
                return (n = '.' + r), t.replace(new RegExp('\\.' + e, 'g'), n);
            }
            function A(t, e) {
                return Array.from(
                    t.querySelectorAll(
                        'style:not([data-styles]):not([data-no-shim])'
                    )
                )
                    .map(function(t) {
                        return k(e, t);
            ...
            function T(t, e, r) {
                ...
                return fetch(n)
                    ...
                    .then(function(s) {
                        if (
                            ((i = s).indexOf('var(') > -1 || N.test(i)) &&
                            r.parentNode
                        ) {
                            (function(t) {
                                return (q.lastIndex = 0), q.test(t);
                            })(s) &&
                                (s = (function(t, e) {
                                    var r = e.replace(/[^/]*$/, '');
                ...
                G = (function() {
                    ...
                    return (
                        ...
                        (t.prototype.addLink = function(t) {
                            var e = this;
                            return T(this.doc, this.globalScopes, t).then(
                                function() {
                                    e.updateGlobal();
                                }
                            );
                        ...
                        (t.prototype.addGlobalStyle = function(t) {
                            k(this.globalScopes, t) && this.updateGlobal();
                        }),
                        (t.prototype.createHostStyle = function(t, e, r, n) {
                            ...
                            var s,
                                ...
                                i,
                                a,
                                u = this.registerHostTemplate(r, e, n),
                                c = this.doc.createElement('style');
                            return (
                                c.setAttribute('data-no-shim', ''),
                                u.usesCssVars
                                    ? n
                                        ? ((c['s-sc'] = e =
                                              u.scopeId + '-' + this.count),
                                          (c.textContent = '/*needs update*/'),
                                          this.hostStyleMap.set(t, c),
            ...
            !(j = 'undefined' != typeof window && window) ||
                ...
                (j.CSS &&
                    j.CSS.supports &&
                    j.CSS.supports('color', 'var(--c)')) ||
                (j.__cssshim = new G(j, j.document));
        },
    },
]);
