(window.webpackJsonp = window.webpackJsonp || []).push([
    [42],
    {
        'lg/V': function(i, t, n) {
            'use strict';
            n.r(t),
                n.d(t, 'ion_infinite_scroll', function() {
                    return o;
                }),
                n.d(t, 'ion_infinite_scroll_content', function() {
                    return r;
                });
            var e = n('imtE'),
                s = n('AfW+'),
            ...
            const o = class {
                    ...
                    thresholdChanged() {
                        ...
                        i.lastIndexOf('%') > -1
                            ...
                            : ((this.thrPx = parseFloat(i)), (this.thrPc = 0));
                    }
                    disabledChanged() {
                        const i = this.disabled;
                        i && ((this.isLoading = !1), (this.isBusy = !1)),
                    ...
                    async complete() {
                        ...
                        if (
                            ...
                            this.isBusy = !0;
                            const t = i.scrollHeight - i.scrollTop;
                            requestAnimationFrame(() => {
                                Object(e.g)(() => {
                                    const n = i.scrollHeight - t;
                                    requestAnimationFrame(() => {
                                        Object(e.l)(() => {
                                            (i.scrollTop = n),
                                                (this.isBusy = !1);
                    ...
                    render() {
                        const i = Object(e.d)(this),
                            t = this.disabled;
                        return Object(e.i)(e.a, {
                            class: {
                                [i]: !0,
                                'infinite-scroll-loading': this.isLoading,
                                'infinite-scroll-enabled': !t,
                            },
                        });
                    }
                    get el() {
