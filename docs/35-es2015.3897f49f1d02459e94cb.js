    ...
    [35],
    {
        '/CAe': function(i, d, n) {
            ...
            const r = {
                ...
                e = class {
                    ...
                    calculateSize() {
                        ...
                        const d =
                            'auto' === i
                                ? 'auto'
                                : o
                                ? `calc(calc(${i} / var(--ion-grid-columns, 12)) * 100%)`
                                : (i / 12) * 100 + '%';
                        return {
                            flex: `0 0 ${d}`,
                            width: `${d}`,
                    ...
                    calculatePosition(i, d) {
                        ...
                        if (n)
                            return {
                                [d]: o
                                    ? `calc(calc(${n} / var(--ion-grid-columns, 12)) * 100%)`
                                    : n > 0 && n < 12
                                    ? (n / 12) * 100 + '%'
                                    : 'auto',
                            };
                                ...
                                style: Object.assign(
                                    Object.assign(
                                        Object.assign(
                                            Object.assign(
                                                {},
                                                this.calculateOffset(i)
                                            ),
                                            this.calculatePull(i)
                                        ),
                ...
                s = class {
                    constructor(i) {
                        Object(a.k)(this, i), (this.fixed = !1);
                    }
                    render() {
                        const i = Object(a.d)(this);
                        return Object(a.i)(
                            a.a,
                            { class: { [i]: !0, 'grid-fixed': this.fixed } },
                            Object(a.i)('slot', null)
                        );
                    }
                    static get style() {
