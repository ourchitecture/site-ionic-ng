(window.webpackJsonp = window.webpackJsonp || []).push([
    [52],
    {
        WHty: function(t, i, e) {
            'use strict';
            e.r(i),
                e.d(i, 'ion_menu', function() {
                    return l;
                }),
                e.d(i, 'ion_menu_button', function() {
                    return v;
                }),
                e.d(i, 'ion_menu_toggle', function() {
                    return f;
                });
            var n = e('imtE'),
                s = e('AfW+'),
            ...
            const l = class {
                    constructor(t) {
                        Object(n.k)(this, t),
                            (this.lastOnEnd = 0),
                            (this.blocker = r.GESTURE_CONTROLLER.createBlocker({
                                disableScroll: !0,
                            })),
                            ...
                            (this.ionWillOpen = Object(n.e)(
                                this,
                                'ionWillOpen',
                                7
                            )),
                            (this.ionWillClose = Object(n.e)(
                                this,
                                'ionWillClose',
                                7
                            )),
                            (this.ionDidOpen = Object(n.e)(
                                this,
                                'ionDidOpen',
                                7
                            )),
                            (this.ionDidClose = Object(n.e)(
                                this,
                                'ionDidClose',
                                7
                            )),
                            (this.ionMenuChange = Object(n.e)(
                                this,
                                'ionMenuChange',
                                7
                            ));
                    ...
                    typeChanged(t, i) {
                        ...
                        e &&
                            (void 0 !== i &&
                                e.classList.remove(`menu-content-${i}`),
                            e.classList.add(`menu-content-${t}`),
                    ...
                    sideChanged() {
                        this.isEndSide = Object(o.h)(this.side);
                    }
                    swipeGestureChanged() {
                        this.updateState();
                    }
                    async connectedCallback() {
                        void 0 === this.type &&
                            (this.type = s.b.get('menuType', 'overlay'));
                    ...
                    async loadAnimation() {
                        ...
                        (t === this.width && void 0 !== this.animation) ||
                            ...
                            this.animation &&
                                ...
                                (this.animation = void 0)),
                            (this.animation = await h.a._createAnimation(
                                this.type,
                                this
                            )),
                            s.b.getBoolean('animated', !0) ||
                    ...
                    async startAnimation(t, i) {
                        const e = !t,
                            n = this.animation
                                ...
                                .easing(e ? this.easingReverse : this.easing)
                                .onFinish(() => {
                                    'reverse' === n.getDirection() &&
                                        n.direction('normal');
                                });
                        i ? await n.play() : n.play({ sync: !0 });
                    }
                    _isActive() {
                    ...
                    onStart() {
                        this.isAnimating && this.animation
                            ...
                            : Object(o.b)(!1, 'isAnimating has to be true');
                    }
                    onMove(t) {
                        ...
                        const i =
                            c(t.deltaX, this._isOpen, this.isEndSide) /
                            this.width;
                    ...
                    onEnd(t) {
                        ...
                        const i = this._isOpen,
                            ...
                            h = t.velocityX,
                            d = s / 2,
                            l = h >= 0 && (h > 0.2 || t.deltaX > d),
                            u = h <= 0 && (h < -0.2 || t.deltaX < -d),
                            m = i ? (e ? l : u) : e ? u : l;
                        let b = !i && m;
                        i && !m && (b = !0), (this.lastOnEnd = t.currentTime);
                        let p = m ? 0.001 : -0.001;
                        const g = r < 0 ? 0.01 : r;
                        p +=
                            Object(a.a)(
                                ...
                                [0.6, 1],
                                [1, 1],
                                Object(o.c)(0, g, 0.9999)
                            )[0] || 0;
                        const v = this._isOpen ? !m : m;
                        this.animation
                            .easing('cubic-bezier(0.4, 0.0, 0.6, 1)')
                            .onFinish(() => this.afterAnimation(b), {
                                oneTimeCallback: !0,
                            })
                            .progressEnd(
                                v ? 1 : 0,
                    ...
                    afterAnimation(t) {
                        Object(o.b)(
                            ...
                            t
                                ? (this.contentEl &&
                                      this.contentEl.classList.add(p),
                                  this.ionDidOpen.emit())
                                : (this.el.classList.remove(m),
                                  this.contentEl &&
                                      this.contentEl.classList.remove(p),
                                  this.backdropEl &&
                                      this.backdropEl.classList.remove(b),
                    ...
                    updateState() {
                        ...
                        this.gesture &&
                            ...
                            this.disabled || h.a._setActiveMenu(this),
                            Object(o.b)(
                                !this.isAnimating,
                    ...
                    forceClosing() {
                        Object(o.b)(this._isOpen, 'menu cannot be closed'),
                            (this.isAnimating = !0),
                            this.animation
                                .direction('reverse')
                                .play({ sync: !0 }),
                ...
                c = (t, i, e) => Math.max(0, i !== e ? -t : t),
                u = (t, i, e, n) => (e ? i >= t.innerWidth - n : i <= n),
                m = 'show-menu',
                b = 'show-backdrop',
                p = 'menu-content-open',
                g = async (t) => {
                    const i = await h.a.get(t);
                    return !(!i || !(await i.isActive()));
                },
                v = class {
                    constructor(t) {
                        Object(n.k)(this, t),
                            ...
                            (this.autoHide = !0),
                            (this.type = 'button'),
                            (this.onClick = async () => h.a.toggle(this.menu));
                    }
                    componentDidLoad() {
                        this.visibilityChanged();
                    }
                    async visibilityChanged() {
                        this.visible = await g(this.menu);
                    }
                    render() {
                        const { color: t, disabled: i } = this,
                            e = Object(n.d)(this),
                            o = s.b.get(
                                'menuIcon',
                                'ios' === e ? 'menu-outline' : 'menu-sharp'
                            ),
                        ...
                        return Object(n.i)(
                            n.a,
                            {
                                ...
                                class: Object.assign(
                                    Object.assign({ [e]: !0 }, Object(d.a)(t)),
                                    {
                                        button: !0,
                                        'menu-button-hidden': a,
                                        'menu-button-disabled': i,
                                        'in-toolbar': Object(d.c)(
                                            'ion-toolbar',
                                            this.el
                                        ),
                                        'in-toolbar-color': Object(d.c)(
                                            'ion-toolbar[color]',
                                            this.el
                                        ),
                                        'ion-activatable': !0,
                ...
                f = class {
                    constructor(t) {
                        Object(n.k)(this, t),
                            (this.visible = !1),
                            (this.autoHide = !0),
                            (this.onClick = () => h.a.toggle(this.menu));
                    }
                    connectedCallback() {
                        this.visibilityChanged();
                    }
                    ...
                    render() {
                        const t = Object(n.d)(this),
                            i = this.autoHide && !this.visible;
                        return Object(n.i)(
                            n.a,
                            {
                                onClick: this.onClick,
                                'aria-hidden': i ? 'true' : null,
                                class: { [t]: !0, 'menu-toggle-hidden': i },
                            },
                            Object(n.i)('slot', null)
                        );
                    }
